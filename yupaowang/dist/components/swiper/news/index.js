...
var SwiperNews = (_temp2 = _class = function (_Taro$Component) {
  ...
  function SwiperNews() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = SwiperNews.__proto__ || Object.getPrototypeOf(SwiperNews)).call.apply(_ref, [this].concat(args))), _this), _this.$usedState = ["swiper", "loopArray109", "data"], _this.customComponents = [], _temp), _possibleConstructorReturn(_this, _ret);
  }
  ...
  _createClass(SwiperNews, [{
    ...
    value: function _createData() {
      ...
      var loopArray109 = swiper.lists.map(function (item, index) {
        item = {
