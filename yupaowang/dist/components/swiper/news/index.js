(qq["webpackJsonp"] = qq["webpackJsonp"] || []).push([["components/swiper/news/index"],{
    ...
    value: function _createData() {
      ...
      var loopArray13 = swiper.lists.map(function (item, __index0) {
        ...
        _this2.anonymousFunc0Map[_$indexKey] = function () {
          return (0, _index2.userJumpPage)("/pages/static/notice/index?id=" + item.$original.id);
        };
        return {
...
Component(__webpack_require__(/*! @tarojs/taro-qq */ "./node_modules/@tarojs/taro-qq/index.js").default.createComponent(SwiperNews));
