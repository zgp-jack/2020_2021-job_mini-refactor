...
var SwiperComponent = (_temp2 = _class = function (_Taro$Component) {
  ...
  function SwiperComponent() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = SwiperComponent.__proto__ || Object.getPrototypeOf(SwiperComponent)).call.apply(_ref, [this].concat(args))), _this), _this.$usedState = ["swiper", "loopArray109", "data"], _this.customComponents = [], _temp), _possibleConstructorReturn(_this, _ret);
  }
