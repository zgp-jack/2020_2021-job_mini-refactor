...
var ResumeList = function (_Taro$Component) {
  ...
  function ResumeList() {
    ...
    _this.$usedState = ["anonymousState__temp", "loopArray11", "data", "IMGCDNURL", "bottom"];
      ...
      var loopArray11 = data ? data.map(function (item, __index1) {
        ...
        var anonymousCallee__2 = item.privateOriginal ? item.privateOriginal.map(function (d, __index0) {
          ...
          _this2.anonymousFunc0Map[_$indexKey] = function () {
            return userRouteJump("/pages/resume/detail/index?uuid=" + d.privateOriginal.uuid + "&location=" + d.privateOriginal.location);
          };
          return {
