...
var ResumeList = (_temp2 = _class = function (_Taro$Component) {
  ...
  function ResumeList() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = ResumeList.__proto__ || Object.getPrototypeOf(ResumeList)).call.apply(_ref, [this].concat(args))), _this), _this.$usedState = ["anonymousState__temp", "data", "IMGCDNURL", "bottom"], _this.customComponents = [], _temp), _possibleConstructorReturn(_this, _ret);
  }
  ...
  return ResumeList;
}(_taroWeapp2.default.Component), _class.$$events = [], _class.$$componentPath = "components/lists/resume/index", _temp2);
