...
var RecruitList = (_temp2 = _class = function (_Taro$Component) {
  ...
  function RecruitList() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = RecruitList.__proto__ || Object.getPrototypeOf(RecruitList)).call.apply(_ref, [this].concat(args))), _this), _this.$usedState = ["anonymousState__temp", "loopArray113", "data", "IMGCDNURL", "bottom"], _this.anonymousFunc0Map = {}, _this.customComponents = [], _temp), _possibleConstructorReturn(_this, _ret);
  }
  ...
  _createClass(RecruitList, [{
    ...
    value: function _createData() {
      ...
      var loopArray113 = data ? data.map(function (item, __index1) {
        item = {
        ...
        var $anonymousCallee__22 = item.$original ? item.$original.map(function (d, __index0) {
          ...
          var _$indexKey = "bbhzz" + __index1 + "-" + __index0;
