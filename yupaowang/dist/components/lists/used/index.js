...
var UsedList = (_temp2 = _class = function (_Taro$Component) {
  ...
  function UsedList() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = UsedList.__proto__ || Object.getPrototypeOf(UsedList)).call.apply(_ref, [this].concat(args))), _this), _this.$usedState = ["anonymousState__temp", "loopArray58", "data", "IMGCDNURL", "bottom"], _this.anonymousFunc0Map = {}, _this.customComponents = [], _temp), _possibleConstructorReturn(_this, _ret);
  }
  ...
  _createClass(UsedList, [{
    ...
    value: function _createData() {
      ...
      var loopArray58 = data.length ? data.map(function (item, __index1) {
        item = {
        ...
        var $anonymousCallee__14 = data.length ? item.$original.map(function (d, __index0) {
          ...
          var _$indexKey = "dgzzz" + __index1 + "-" + __index0;
