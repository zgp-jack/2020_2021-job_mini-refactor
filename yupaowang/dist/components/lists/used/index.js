(qq["webpackJsonp"] = qq["webpackJsonp"] || []).push([["components/lists/used/index"],{
  ...
  _createClass(UsedList, [{
    ...
    value: function _createData() {
      ...
      var loopArray25 = data.length ? data.map(function (item, __index1) {
        ...
        var $anonymousCallee__6 = data.length ? item.$original.map(function (d, __index0) {
          d = {
...
Component(__webpack_require__(/*! @tarojs/taro-qq */ "./node_modules/@tarojs/taro-qq/index.js").default.createComponent(UsedList));
