(qq["webpackJsonp"] = qq["webpackJsonp"] || []).push([["components/profession/index"],{
  ...
  _createClass(Profession, [{
    ...
    value: function _createData() {
      ...
      var loopArray44 = data ? data.map(function (item, i) {
        ...
        var $anonymousCallee__8 = data ? item.$original.children.map(function (d, k) {
          d = {
            $original: (0, _taroQq.internal_get_original)(d)
          };
          var _$indexKey = 'eizzz' + i + '-' + k;
...
Component(__webpack_require__(/*! @tarojs/taro-qq */ "./node_modules/@tarojs/taro-qq/index.js").default.createComponent(Profession));
