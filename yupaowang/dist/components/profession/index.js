...
var Profession = function (_Taro$Component) {
  ...
  function Profession() {
    ...
    _this.$usedState = ["loopArray90", "data", "title", "footerTitle", "closeProfession", "onClickItem"];
  ...
  _createClass(Profession, [{
    ...
    value: function _createData() {
      ...
      var loopArray90 = data ? data.map(function (item, i) {
        item = {
          privateOriginal: (0, _taroSwan.internal_get_original)(item)
        };
        var anonymousCallee__10 = data ? item.privateOriginal.children.map(function (d, k) {
          d = {
            privateOriginal: (0, _taroSwan.internal_get_original)(d)
          };
          var _$indexKey = 'jbzzz' + i + '-' + k;
