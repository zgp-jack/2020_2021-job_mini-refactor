...
var Profession = (_temp2 = _class = function (_Taro$Component) {
  ...
  _createClass(Profession, [{
    ...
    value: function _createData() {
      ...
      var loopArray93 = data ? data.map(function (item, i) {
        item = {
