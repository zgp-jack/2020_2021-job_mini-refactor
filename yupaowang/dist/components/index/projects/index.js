(qq["webpackJsonp"] = qq["webpackJsonp"] || []).push([["components/index/projects/index"],{
...
var Projects = function (_Taro$Component) {
  ...
  function Projects() {
    ...
    _this.$usedState = ["loopArray19", "FastBarConfig"];
    ...
    value: function _createData() {
      ...
      var FastbarAction = function FastbarAction(item) {
        if (item.target === 'miniProgram') {
          // * 如果是小程序就跳转其他小程序
          _taroQq2.default.navigateToMiniProgram({ appId: item.appid, fail: function fail(err) {
              return console.log(err);
            } });
        } else if (item.isout) {
          // * 不在TabBar组件中就跳转其他页面
          _taroQq2.default.navigateTo({ url: item.url });
        }
      };
      var loopArray19 = _config2.default.map(function (item, index) {
        item = {
          $original: (0, _taroQq.internal_get_original)(item)
        };
        var $loopState__temp2 = index + item.$original.appid;
        var _$indexKey = "cdzzz" + index;
...
Component(__webpack_require__(/*! @tarojs/taro-qq */ "./node_modules/@tarojs/taro-qq/index.js").default.createComponent(Projects));
