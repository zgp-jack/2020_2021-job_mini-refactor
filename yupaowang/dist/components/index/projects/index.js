...
var Projects = (_temp2 = _class = function (_Taro$Component) {
  ...
  function Projects() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = Projects.__proto__ || Object.getPrototypeOf(Projects)).call.apply(_ref, [this].concat(args))), _this), _this.$usedState = ["loopArray74", "FastBarConfig"], _this.anonymousFunc0Map = {}, _this.customComponents = [], _temp), _possibleConstructorReturn(_this, _ret);
  }
  ...
  _createClass(Projects, [{
    ...
    value: function _createData() {
      ...
      var loopArray74 = _config2.default.map(function (item, index) {
        item = {
