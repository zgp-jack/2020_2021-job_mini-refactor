(qq["webpackJsonp"] = qq["webpackJsonp"] || []).push([["components/auth/index"],{
  ...
  _createClass(Auth, [{
    ...
    value: function _createData() {
      ...
      var decodeSessionKey = function decodeSessionKey(key) {
        _taroQq2.default.getSetting({
          success: function success(res) {
            if (!res.authSetting['scope.userInfo']) {
              _taroQq2.default.getUserInfo({
                success: function success() {
                  doAuthRequest(key);
                },
                fail: function fail() {
                  _taroQq2.default.openSetting();
                }
              });
            } else {
              doAuthRequest(key);
      ...
      var doAuthRequest = function doAuthRequest(key) {
        _taroQq2.default.getUserInfo({
          success: function success(res) {
            ...
            var iv = res.iv;
            var refId = _taroQq2.default.getStorageSync(_store.REFID);
            var data = {
              session_key: key,
            ...
            (0, _index2.GetUserInfo)(data).then(function (res) {
              if (res.errcode === 'ok') {
                ...
                _taroQq2.default.setStorageSync(_store.UserInfo, user);
...
Component(__webpack_require__(/*! @tarojs/taro-qq */ "./node_modules/@tarojs/taro-qq/index.js").default.createComponent(Auth));
