...
var Condition = function (_Taro$Component) {
  ...
  function Condition() {
    ...
    _this.$usedState = ["anonymousState__temp", "loopArray5", "loopArray6", "$compid__6", "data", "IMGCDNURL", "AREAS", "childAreaList", "scrollTop"];
  ...
  _createClass(Condition, [{
    ...
    value: function _createData() {
      ...
      var loopArray5 = data ? data.map(function (item, __index0) {
        item = {
      ...
      var loopArray6 = _area2.default.map(function (item, index) {
        item = {
          $original: (0, _taroWeapp.internal_get_original)(item)
        };
