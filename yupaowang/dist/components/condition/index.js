(swan["webpackJsonp"] = swan["webpackJsonp"] || []).push([["components/condition/index"],{
...
var Condition = function (_Taro$Component) {
  ...
  function Condition() {
    ...
    _this.$usedState = ["anonymousState__temp", "loopArray13", "loopArray14", "$compid__13", "data", "IMGCDNURL", "AREAS", "childAreaList", "scrollTop"];
  ...
  _createClass(Condition, [{
    ...
    value: function _createData() {
      ...
      var _genCompid = (0, _taroSwan.genCompid)(__prefix + "$compid__13"),
      ...
      var _useState5 = (0, _taroSwan.useState)(_area2.default[areaIndex].children),
      ...
      var loopArray13 = data ? data.map(function (item, __index0) {
        item = {
          privateOriginal: (0, _taroSwan.internal_get_original)(item)
        };
        var _$indexKey = "bezzz" + __index0;
        _this2.anonymousFunc0Map[_$indexKey] = function () {
          return conditionItemClick(item.privateOriginal.id);
        };
        return {
      ...
      var loopArray14 = _area2.default.map(function (item, index) {
        item = {
          privateOriginal: (0, _taroSwan.internal_get_original)(item)
        };
...
exports.default = (0, _taroSwan.memo)(Condition);

Component(__webpack_require__(/*! @tarojs/taro-swan */ "./node_modules/@tarojs/taro-swan/index.js").default.createComponent(Condition));
