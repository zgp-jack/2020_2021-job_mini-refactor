(swan["webpackJsonp"] = swan["webpackJsonp"] || []).push([["components/recommendList/resumeList/index"],{
...
var ResumeListPage = function (_Taro$Component) {
  ...
  function ResumeListPage() {
    ...
    _this.$usedState = ["loopArray52", "data", "IMGCDNURL"];
  ...
  _createClass(ResumeListPage, [{
    ...
    value: function _createData() {
      ...
      var loopArray52 = data.map(function (item, __index0) {
        item = {
          privateOriginal: (0, _taroSwan.internal_get_original)(item)
        };
        var _$indexKey = "fgzzz" + __index0;
        _this2.anonymousFunc0Map[_$indexKey] = function () {
          return userRouteJump("/pages/resume/detail/index?uuid=" + item.privateOriginal.uuid + "&location=" + item.privateOriginal.location);
        };
        var anonymousCallee__8 = item.privateOriginal.occupations.map(function (v, i) {
          v = {
...
Component(__webpack_require__(/*! @tarojs/taro-swan */ "./node_modules/@tarojs/taro-swan/index.js").default.createComponent(ResumeListPage));
