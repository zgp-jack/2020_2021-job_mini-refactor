...
var RecruitListPage = (_temp2 = _class = function (_Taro$Component) {
  ...
  function RecruitListPage() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = RecruitListPage.__proto__ || Object.getPrototypeOf(RecruitListPage)).call.apply(_ref, [this].concat(args))), _this), _this.$usedState = ["loopArray105", "data", "IMGCDNURL"], _this.anonymousFunc0Map = {}, _this.customComponents = [], _temp), _possibleConstructorReturn(_this, _ret);
  }
