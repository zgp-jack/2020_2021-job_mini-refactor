...
var RecruitListPage = (_temp2 = _class = function (_Taro$Component) {
  ...
  function RecruitListPage() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = RecruitListPage.__proto__ || Object.getPrototypeOf(RecruitListPage)).call.apply(_ref, [this].concat(args))), _this), _this.$usedState = ["loopArray102", "data", "IMGCDNURL"], _this.anonymousFunc0Map = {}, _this.customComponents = [], _temp), _possibleConstructorReturn(_this, _ret);
  }
  ...
  _createClass(RecruitListPage, [{
    ...
    value: function _createData() {
      ...
      var loopArray102 = data.map(function (v, __index0) {
        v = {
