...
var Cities = function (_Taro$Component) {
  ...
  function Cities() {
    ...
    _this.$usedState = ["loopArray41", "loopArray42", "loopArray43", "text", "IMGCDNURL", "recentlyCities", "userLoc", "data", "show", "inputCity", "area", "parent", "userTapCityBtn", "userChangeCity"];
