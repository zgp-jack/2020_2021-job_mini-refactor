...
var Cities = (_temp2 = _class = function (_Taro$Component) {
  ...
  function Cities() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = Cities.__proto__ || Object.getPrototypeOf(Cities)).call.apply(_ref, [this].concat(args))), _this), _this.$usedState = ["loopArray66", "loopArray67", "loopArray68", "text", "IMGCDNURL", "userLoc", "recentlyCities", "data", "show", "inputCity", "area", "parent", "userTapCityBtn", "userChangeCity"], _this.anonymousFunc4Map = {}, _this.anonymousFunc5Map = {}, _this.anonymousFunc6Map = {}, _this.customComponents = [], _temp), _possibleConstructorReturn(_this, _ret);
  }
  ...
  _createClass(Cities, [{
    ...
    value: function _createData() {
      ...
      var loopArray66 = recentlyCities.map(function (item, __index4) {
        item = {
          $original: (0, _taroWeapp.internal_get_original)(item)
        };
        var $loopState__temp2 = 'rec' + item.$original.id;

        var _$indexKey = "gezzz" + __index4;
      ...
      var loopArray67 = data.map(function (item, index) {
        item = {
          $original: (0, _taroWeapp.internal_get_original)(item)
        };
        var $loopState__temp4 = index + item.$original[0].id;
        var $anonymousCallee__9 = item.$original.map(function (d, key) {
          d = {
            $original: (0, _taroWeapp.internal_get_original)(d)
          };
          var $loopState__temp6 = key + d.$original.id;
          var _$indexKey2 = "gfzzz" + index + "-" + key;
      ...
      var loopArray68 = show ? inputCity.map(function (item, __index6) {
        item = {
          $original: (0, _taroWeapp.internal_get_original)(item)
        };

        var _$indexKey3 = "ggzzz" + __index6;
