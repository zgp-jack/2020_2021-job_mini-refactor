...
var Cities = (_temp2 = _class = function (_Taro$Component) {
  ...
  _createClass(Cities, [{
    ...
    value: function _createData() {
      ...
      var loopArray75 = recentlyCities.map(function (item, __index4) {
        item = {
          $original: (0, _taroWeapp.internal_get_original)(item)
        };
        var $loopState__temp2 = 'rec' + item.$original.id;

        var _$indexKey = "hdzzz" + __index4;
      ...
      var loopArray76 = data.map(function (item, index) {
        item = {
          $original: (0, _taroWeapp.internal_get_original)(item)
        };
        ...
        var $anonymousCallee__10 = item.$original.map(function (d, key) {
          ...
          var _$indexKey2 = "hezzz" + index + "-" + key;
      ...
      var loopArray77 = show ? inputCity.map(function (item, __index6) {
        item = {
          $original: (0, _taroWeapp.internal_get_original)(item)
        };

        var _$indexKey3 = "hfzzz" + __index6;
