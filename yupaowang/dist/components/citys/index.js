(qq["webpackJsonp"] = qq["webpackJsonp"] || []).push([["components/citys/index"],{
...
var Cities = function (_Taro$Component) {
  ...
  function Cities() {
    ...
    _this.$usedState = ["loopArray50", "loopArray51", "loopArray52", "text", "IMGCDNURL", "userLoc", "recentlyCities", "data", "show", "inputCity", "area", "parent", "userTapCityBtn", "userChangeCity"];
  ...
  _createClass(Cities, [{
    ...
    value: function _createData() {
      ...
      var userTapCity = function userTapCity(city) {
        var historyCities = _taroQq2.default.getStorageSync(_store.HistoryCities);
        if (historyCities) {
          var id = city.id;
        ...
        // 储存最新的用户点击历史城市数据
        _taroQq2.default.setStorageSync(_store.HistoryCities, historyCities);
...
Component(__webpack_require__(/*! @tarojs/taro-qq */ "./node_modules/@tarojs/taro-qq/index.js").default.createComponent(Cities));
