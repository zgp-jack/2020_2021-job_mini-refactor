...
var Cities = function (_Taro$Component) {
  ...
  function Cities() {
    ...
    _this.$usedState = ["loopArray39", "loopArray40", "loopArray41", "text", "IMGCDNURL", "userLoc", "recentlyCities", "data", "show", "inputCity", "area", "parent", "userTapCityBtn", "userChangeCity"];
  ...
  _createClass(Cities, [{
    ...
    value: function _createData() {
      ...
      var loopArray39 = recentlyCities.map(function (item, __index4) {
        item = {
          $original: (0, _taroTt.internal_get_original)(item)
        };
        var $loopState__temp2 = 'rec' + item.$original.id;
        var _$indexKey = "eazzz" + __index4;
      ...
      var loopArray40 = data.map(function (item, index) {
        item = {
          $original: (0, _taroTt.internal_get_original)(item)
        };
        ...
        var $anonymousCallee__6 = item.$original.map(function (d, key) {
          ...
          var _$indexKey2 = "ebzzz" + index + "-" + key;
      ...
      var loopArray41 = show ? inputCity.map(function (item, __index6) {
        item = {
          $original: (0, _taroTt.internal_get_original)(item)
        };
        var _$indexKey3 = "eczzz" + __index6;
