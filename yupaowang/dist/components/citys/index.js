...
var Cities = (_temp2 = _class = function (_Taro$Component) {
  ...
  function Cities() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = Cities.__proto__ || Object.getPrototypeOf(Cities)).call.apply(_ref, [this].concat(args))), _this), _this.$usedState = ["loopArray62", "loopArray63", "loopArray64", "text", "IMGCDNURL", "userLoc", "recentlyCities", "data", "show", "inputCity", "area", "parent", "userTapCityBtn", "userChangeCity"], _this.anonymousFunc4Map = {}, _this.anonymousFunc5Map = {}, _this.anonymousFunc6Map = {}, _this.customComponents = [], _temp), _possibleConstructorReturn(_this, _ret);
  }
  ...
  _createClass(Cities, [{
    ...
    value: function _createData() {
      ...
      var loopArray62 = recentlyCities.map(function (item, __index4) {
        item = {
          $original: (0, _taroWeapp.internal_get_original)(item)
        };
        var $loopState__temp2 = 'rec' + item.$original.id;

        var _$indexKey = "gbzzz" + __index4;
      ...
      var loopArray63 = data.map(function (item, index) {
        item = {
          $original: (0, _taroWeapp.internal_get_original)(item)
        };
        ...
        var $anonymousCallee__10 = item.$original.map(function (d, key) {
          ...
          var _$indexKey2 = "gczzz" + index + "-" + key;
      ...
      var loopArray64 = show ? inputCity.map(function (item, __index6) {
        item = {
          $original: (0, _taroWeapp.internal_get_original)(item)
        };

        var _$indexKey3 = "gdzzz" + __index6;
