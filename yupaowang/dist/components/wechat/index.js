...
var WechatNotice = (_temp2 = _class = function (_Taro$Component) {
  ...
  function WechatNotice() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = WechatNotice.__proto__ || Object.getPrototypeOf(WechatNotice)).call.apply(_ref, [this].concat(args))), _this), _this.$usedState = ["$compid__88", "wechatNoticeData"], _this.customComponents = ["SwiperNews"], _temp), _possibleConstructorReturn(_this, _ret);
  }
