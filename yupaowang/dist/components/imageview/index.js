...
var ImageView = (_temp2 = _class = function (_Taro$Component) {
  ...
  function ImageView() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = ImageView.__proto__ || Object.getPrototypeOf(ImageView)).call.apply(_ref, [this].concat(args))), _this), _this.$usedState = ["loopArray65", "images", "max", "userUploadImg"], _this.anonymousFunc0Map = {}, _this.customComponents = [], _temp), _possibleConstructorReturn(_this, _ret);
  }
  ...
  _createClass(ImageView, [{
    ...
    value: function _createData() {
      ...
      var loopArray65 = images ? images.map(function (item, index) {
        item = {
