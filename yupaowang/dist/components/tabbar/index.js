...
var Tabbar = function (_Taro$Component) {
  ...
  function Tabbar() {
    ...
    _this.$usedState = ["anonymousState__temp3", "anonymousState__temp4", "anonymousState__temp5", "tabbar", "loopArray27", "memberMsg", "show", "IMGCDNURL", "notredirect"];
  ...
  _createClass(Tabbar, [{
    ...
    value: function _createData() {
      ...
      var loopArray27 = tabbar.list.map(function (item, __index0) {
        item = {
