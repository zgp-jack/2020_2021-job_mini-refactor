(qq["webpackJsonp"] = qq["webpackJsonp"] || []).push([["components/tabbar/index"],{
  ...
  _createClass(Tabbar, [{
    ...
    value: function _createData() {
      ...
      var changeTabbarAction = function changeTabbarAction(item) {
        ...
        } else _taroQq2.default.reLaunch({ url: '/pages/index/index?type=' + item.id });
      };
      // 点击发布按钮
...
Component(__webpack_require__(/*! @tarojs/taro-qq */ "./node_modules/@tarojs/taro-qq/index.js").default.createComponent(Tabbar));
