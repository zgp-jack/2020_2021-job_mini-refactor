...
var Tabbar = function (_Taro$Component) {
  ...
  function Tabbar() {
    ...
    _this.$usedState = ["anonymousState__temp3", "anonymousState__temp4", "anonymousState__temp5", "tabbar", "loopArray17", "memberMsg", "show", "IMGCDNURL", "notredirect"];
  ...
  _createClass(Tabbar, [{
    ...
    value: function _createData() {
      ...
      // })
      // 清除页面定时器
      (0, _taroSwan.onAppHide)(function () {
        clearInterval(timer);
      });
      ...
      var loopArray17 = tabbar.list.map(function (item, __index0) {
        item = {
