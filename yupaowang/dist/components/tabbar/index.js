...
var Tabbar = (_temp2 = _class = function (_Taro$Component) {
  ...
  _createClass(Tabbar, [{
    ...
    value: function _createData() {
      ...
      var loopArray102 = tabbar.list.map(function (item, __index0) {
        item = {
