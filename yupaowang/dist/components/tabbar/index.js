...
var Tabbar = (_temp2 = _class = function (_Taro$Component) {
  ...
  function Tabbar() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = Tabbar.__proto__ || Object.getPrototypeOf(Tabbar)).call.apply(_ref, [this].concat(args))), _this), _this.$usedState = ["tabbar", "loopArray40", "memberMsg", "notredirect"], _this.anonymousFunc0Map = {}, _this.customComponents = [], _temp), _possibleConstructorReturn(_this, _ret);
  }
