...
var FeedbackList = (_temp2 = _class = function (_Taro$Component) {
  ...
  function FeedbackList() {
    ...
    }, _this.$usedState = ["lists", "loopArray71", "$compid__59", "isDown"], _this.anonymousFunc0Map = {}, _this.customComponents = ["Auth", "WechatNotice", "Nodata"], _temp), _possibleConstructorReturn(_this, _ret);
  }
  ...
  _createClass(FeedbackList, [{
    ...
    value: function _createData() {
      ...
      var loopArray71 = lists.item ? lists.item.map(function (item, __index1) {
        item = {
          $original: (0, _taroWeapp.internal_get_original)(item)
        };
        var $anonymousCallee__15 = item.$original.images ? item.$original.images.map(function (v, index) {
          v = {
            $original: (0, _taroWeapp.internal_get_original)(v)
          };
          var $loopState__temp2 = item.$original.images ? index + index : null;
          var _$indexKey = "ffzzz" + __index1 + "-" + index;
