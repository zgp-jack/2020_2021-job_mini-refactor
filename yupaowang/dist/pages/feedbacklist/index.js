...
var FeedbackList = (_temp2 = _class = function (_Taro$Component) {
  ...
  function FeedbackList() {
    ...
    }, _this.$usedState = ["lists", "loopArray79", "$compid__68", "isDown"], _this.anonymousFunc0Map = {}, _this.customComponents = ["Auth", "WechatNotice", "Nodata"], _temp), _possibleConstructorReturn(_this, _ret);
  }
