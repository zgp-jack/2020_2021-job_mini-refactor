...
var FeedbackList = function (_Taro$Component) {
  ...
  function FeedbackList() {
    ...
    _this.$usedState = ["lists", "loopArray64", "$compid__56", "isDown"];
  ...
  _createClass(FeedbackList, [{
    ...
    value: function _createData() {
      ...
      var loopArray64 = lists.item ? lists.item.map(function (item, __index1) {
        item = {
        ...
        var $anonymousCallee__7 = item.$original.images ? item.$original.images.map(function (v, index) {
          ...
          var _$indexKey = "hhzzz" + __index1 + "-" + index;
