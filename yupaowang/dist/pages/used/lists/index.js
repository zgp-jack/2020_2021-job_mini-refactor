...
var Fleamarket = function (_Taro$Component) {
  ...
  function Fleamarket() {
    ...
    _this.$usedState = ["anonymousState__temp", "anonymousState__temp2", "anonymousState__temp3", "anonymousState__temp4", "$compid__31", "$compid__32", "$compid__33", "refresh"];
  ...
  _createClass(Fleamarket, [{
    ...
    value: function _createData() {
      ...
      var _genCompid3 = (0, _taroTt.genCompid)(__prefix + "$compid__32"),
          _genCompid4 = _slicedToArray(_genCompid3, 2),
          $prevCompid__32 = _genCompid4[0],
          $compid__32 = _genCompid4[1];

      var _genCompid5 = (0, _taroTt.genCompid)(__prefix + "$compid__33"),
