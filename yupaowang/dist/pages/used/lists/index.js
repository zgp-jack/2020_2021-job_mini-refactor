...
var Fleamarket = (_temp2 = _class = function (_Taro$Component) {
  ...
  function Fleamarket() {
    ...
    }, _this.$usedState = ["anonymousState__temp", "$compid__77", "$compid__78", "$compid__79", "refresh"], _this.customComponents = ["Search", "Condition", "WechatNotice", "UsedList", "Tabbar"], _temp), _possibleConstructorReturn(_this, _ret);
  }
  ...
  _createClass(Fleamarket, [{
    ...
    value: function _createData() {
      ...
      var _genCompid3 = (0, _taroWeapp.genCompid)(__prefix + "$compid__78"),
          _genCompid4 = _slicedToArray(_genCompid3, 2),
          $prevCompid__78 = _genCompid4[0],
          $compid__78 = _genCompid4[1];

      var _genCompid5 = (0, _taroWeapp.genCompid)(__prefix + "$compid__79"),
          _genCompid6 = _slicedToArray(_genCompid5, 2),
          $prevCompid__79 = _genCompid6[0],
          $compid__79 = _genCompid6[1];
