...
var Fleamarket = function (_Taro$Component) {
  ...
  function Fleamarket() {
    ...
    _this.$usedState = ["anonymousState__temp", "$compid__23", "$compid__24", "$compid__25", "refresh"];
  ...
  _createClass(Fleamarket, [{
    ...
    value: function _createData() {
      ...
      var _genCompid = (0, _taroSwan.genCompid)(__prefix + "$compid__23"),
          _genCompid2 = _slicedToArray(_genCompid, 2),
          $prevCompid__23 = _genCompid2[0],
          $compid__23 = _genCompid2[1];

      var _genCompid3 = (0, _taroSwan.genCompid)(__prefix + "$compid__24"),
          _genCompid4 = _slicedToArray(_genCompid3, 2),
          $prevCompid__24 = _genCompid4[0],
          $compid__24 = _genCompid4[1];

      var _genCompid5 = (0, _taroSwan.genCompid)(__prefix + "$compid__25"),
