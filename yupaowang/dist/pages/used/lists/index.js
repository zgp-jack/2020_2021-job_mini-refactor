...
var Fleamarket = (_temp2 = _class = function (_Taro$Component) {
  ...
  function Fleamarket() {
    ...
    }, _this.$usedState = ["anonymousState__temp", "$compid__84", "$compid__85", "$compid__86", "refresh"], _this.customComponents = ["Search", "Condition", "WechatNotice", "UsedList", "Tabbar"], _temp), _possibleConstructorReturn(_this, _ret);
  }
  ...
  _createClass(Fleamarket, [{
    ...
    value: function _createData() {
      ...
      var _genCompid5 = (0, _taroWeapp.genCompid)(__prefix + "$compid__86"),
          _genCompid6 = _slicedToArray(_genCompid5, 2),
          $prevCompid__86 = _genCompid6[0],
          $compid__86 = _genCompid6[1];
