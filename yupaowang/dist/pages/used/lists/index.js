...
var Fleamarket = (_temp2 = _class = function (_Taro$Component) {
  ...
  function Fleamarket() {
    ...
    }, _this.$usedState = ["anonymousState__temp", "$compid__81", "$compid__82", "$compid__83", "refresh"], _this.customComponents = ["Search", "Condition", "WechatNotice", "UsedList", "Tabbar"], _temp), _possibleConstructorReturn(_this, _ret);
  }
