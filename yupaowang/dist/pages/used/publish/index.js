...
var UsedPublish = function (_Taro$Component) {
  ...
  function UsedPublish() {
    ...
    _this.$usedState = ["initModel", "loopArray50", "loopArray51", "$compid__45", "$compid__46", "parentCurrent", "model", "classifyName", "areaProvince", "areaCity", "pIndex", "cIndex", "cityName", "userTel", "showDrawer", "text"];
