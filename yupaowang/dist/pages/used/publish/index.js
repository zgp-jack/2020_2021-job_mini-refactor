...
var UsedPublish = function (_Taro$Component) {
  ...
  function UsedPublish() {
    ...
    _this.$usedState = ["initModel", "loopArray37", "loopArray38", "$compid__33", "$compid__34", "parentCurrent", "model", "classifyName", "areaProvince", "areaCity", "pIndex", "cIndex", "cityName", "userTel", "text"];
  ...
  _createClass(UsedPublish, [{
    ...
    value: function _createData() {
      ...
      var loopArray37 = initModel ? initModel.classifyTree.map(function (item, index) {
        item = {
      ...
      var loopArray38 = initModel ? initModel.classifyTree[parentCurrent].attributes.map(function (item, k) {
        item = {
          $original: (0, _taroTt.internal_get_original)(item)
        };
