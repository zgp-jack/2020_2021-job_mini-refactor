...
var UsedPublish = function (_Taro$Component) {
  ...
  function UsedPublish() {
    ...
    _this.$usedState = ["initModel", "loopArray44", "loopArray45", "$compid__39", "$compid__40", "parentCurrent", "model", "classifyName", "areaProvince", "areaCity", "pIndex", "cIndex", "cityName", "userTel", "text"];
  ...
  _createClass(UsedPublish, [{
    ...
    value: function _createData() {
      ...
      var _genCompid3 = (0, _taroTt.genCompid)(__prefix + "$compid__40"),
      ...
      var loopArray44 = initModel ? initModel.classifyTree.map(function (item, index) {
        item = {
      ...
      var loopArray45 = initModel ? initModel.classifyTree[parentCurrent].attributes.map(function (item, k) {
        item = {
          $original: (0, _taroTt.internal_get_original)(item)
        };
