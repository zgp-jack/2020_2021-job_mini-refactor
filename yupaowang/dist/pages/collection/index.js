...
var Collection = (_temp2 = _class = function (_Taro$Component) {
  ...
  function Collection() {
    ...
    }, _this.$usedState = ["loopArray77", "$compid__64", "$compid__65", "tab", "current"], _this.anonymousFunc0Map = {}, _this.customComponents = ["Auth", "RecruitList", "ResumeList"], _temp), _possibleConstructorReturn(_this, _ret);
  }
  ...
  _createClass(Collection, [{
    ...
    value: function _createData() {
      ...
      var loopArray77 = tab.map(function (item, __index0) {
        item = {
