...
var Collection = function (_Taro$Component) {
  ...
  function Collection() {
    ...
    _this.$usedState = ["loopArray69", "$compid__55", "$compid__56", "tab", "current"];
  ...
  _createClass(Collection, [{
    ...
    value: function _createData() {
      ...
      var _genCompid = (0, _taroQq.genCompid)(__prefix + "$compid__55"),
          _genCompid2 = _slicedToArray(_genCompid, 2),
          $prevCompid__55 = _genCompid2[0],
          $compid__55 = _genCompid2[1];

      var _genCompid3 = (0, _taroQq.genCompid)(__prefix + "$compid__56"),
      ...
      var loopArray69 = _config2.default.map(function (item, __index0) {
        item = {
