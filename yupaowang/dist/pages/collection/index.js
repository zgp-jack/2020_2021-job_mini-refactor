...
var Collection = (_temp2 = _class = function (_Taro$Component) {
  ...
  function Collection() {
    ...
    }, _this.$usedState = ["loopArray78", "$compid__66", "$compid__67", "tab", "current"], _this.anonymousFunc0Map = {}, _this.customComponents = ["Auth", "RecruitList", "ResumeList"], _temp), _possibleConstructorReturn(_this, _ret);
  }
