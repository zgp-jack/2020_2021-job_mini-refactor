...
var CollectionResumeList = function (_Taro$Component) {
  ...
  function CollectionResumeList() {
    ...
    _this.$usedState = ["anonymousState__temp", "loopArray58", "$compid__49", "$compid__50", "data", "IMGCDNURL", "recruitNoMoreData", "modalContent", "bottom", "onHandlerClick"];
  ...
  _createClass(CollectionResumeList, [{
    ...
    value: function _createData() {
      ...
      var _genCompid3 = (0, _taroTt.genCompid)(__prefix + "$compid__50"),
      ...
      var loopArray58 = data ? data.map(function (item, __index0) {
        item = {
