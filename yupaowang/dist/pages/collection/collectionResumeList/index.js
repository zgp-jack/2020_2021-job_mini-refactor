...
var CollectionResumeList = function (_Taro$Component) {
  ...
  function CollectionResumeList() {
    ...
    _this.$usedState = ["anonymousState__temp", "loopArray62", "$compid__53", "$compid__54", "data", "IMGCDNURL", "recruitNoMoreData", "modalContent", "bottom", "onHandlerClick"];
  ...
  _createClass(CollectionResumeList, [{
    ...
    value: function _createData() {
      ...
      var _genCompid3 = (0, _taroTt.genCompid)(__prefix + "$compid__54"),
