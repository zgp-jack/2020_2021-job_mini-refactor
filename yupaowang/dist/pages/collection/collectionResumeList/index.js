...
var CollectionResumeList = function (_Taro$Component) {
  ...
  function CollectionResumeList() {
    ...
    _this.$usedState = ["anonymousState__temp", "loopArray40", "$compid__38", "$compid__39", "data", "IMGCDNURL", "recruitNoMoreData", "modalContent", "bottom", "onHandlerClick"];
  ...
  _createClass(CollectionResumeList, [{
    ...
    value: function _createData() {
      ...
      var _genCompid = (0, _taroSwan.genCompid)(__prefix + "$compid__38"),
          _genCompid2 = _slicedToArray(_genCompid, 2),
          $prevCompid__38 = _genCompid2[0],
          $compid__38 = _genCompid2[1];

      var _genCompid3 = (0, _taroSwan.genCompid)(__prefix + "$compid__39"),
      ...
      var loopArray40 = data ? data.map(function (item, __index0) {
        item = {
          privateOriginal: (0, _taroSwan.internal_get_original)(item)
        };
        var _$indexKey = "edzzz" + __index0;
        _this2.anonymousFunc0Map[_$indexKey] = function () {
          return onHandleClick(item.privateOriginal.resume.check);
        };
        var _$indexKey2 = "eezzz" + __index0;
