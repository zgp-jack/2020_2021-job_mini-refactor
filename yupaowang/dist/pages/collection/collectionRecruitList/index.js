...
var CollectionRecruitList = function (_Taro$Component) {
  ...
  function CollectionRecruitList() {
    ...
    _this.$usedState = ["anonymousState__temp", "loopArray70", "$compid__58", "$compid__59", "data", "IMGCDNURL", "recruitNoMoreData", "modalContent", "bottom", "onHandlerClick"];
  ...
  _createClass(CollectionRecruitList, [{
    ...
    value: function _createData() {
      ...
      var _genCompid3 = (0, _taroQq.genCompid)(__prefix + "$compid__59"),
