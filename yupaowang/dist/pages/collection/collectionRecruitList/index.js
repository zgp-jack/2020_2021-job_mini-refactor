...
var CollectionRecruitList = function (_Taro$Component) {
  ...
  function CollectionRecruitList() {
    ...
    _this.$usedState = ["anonymousState__temp", "loopArray50", "$compid__39", "$compid__40", "data", "IMGCDNURL", "recruitNoMoreData", "modalContent", "bottom", "onHandlerClick"];
  ...
  _createClass(CollectionRecruitList, [{
    ...
    value: function _createData() {
      ...
      var loopArray50 = data ? data.map(function (item, __index0) {
        item = {
        ...
        var _$indexKey2 = "fjzzz" + __index0;
