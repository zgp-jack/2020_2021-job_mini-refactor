...
var CollectionRecruitList = function (_Taro$Component) {
  ...
  function CollectionRecruitList() {
    ...
    _this.$usedState = ["anonymousState__temp", "loopArray39", "$compid__34", "$compid__35", "data", "IMGCDNURL", "recruitNoMoreData", "modalContent", "bottom", "onHandlerClick"];
  ...
  _createClass(CollectionRecruitList, [{
    ...
    value: function _createData() {
      ...
      var _genCompid = (0, _taroSwan.genCompid)(__prefix + "$compid__34"),
          _genCompid2 = _slicedToArray(_genCompid, 2),
          $prevCompid__34 = _genCompid2[0],
          $compid__34 = _genCompid2[1];

      var _genCompid3 = (0, _taroSwan.genCompid)(__prefix + "$compid__35"),
      ...
      var loopArray39 = data ? data.map(function (item, __index0) {
        item = {
          privateOriginal: (0, _taroSwan.internal_get_original)(item)
        };
        var _$indexKey = "ebzzz" + __index0;
        _this2.anonymousFunc0Map[_$indexKey] = function () {
          onHandleClick(item.privateOriginal.is_check);
        };
        var _$indexKey2 = "eczzz" + __index0;
