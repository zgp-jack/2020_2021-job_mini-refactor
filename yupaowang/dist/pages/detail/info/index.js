...
var DetailInfoPage = function (_Taro$Component) {
  ...
  function DetailInfoPage() {
    ...
    _this.$usedState = ["anonymousState__temp3", "data", "loopArray74", "loopArray75", "$compid__66", "$compid__67", "$compid__68", "resCode", "editPhone", "SHOWOFFICIALACCOUNT", "DOWNLOADAPP", "IMGCDNURL", "isCollection", "ISCANSHARE", "recommendRe", "recommend", "complaintModal", "phone"];
  ...
  _createClass(DetailInfoPage, [{
    ...
    value: function _createData() {
      ...
      var _genCompid5 = (0, _taroTt.genCompid)(__prefix + "$compid__68"),
      ...
      var _useState27 = (0, _taroTt.useState)([]),
          ...
          recommendRe = _useState28[0],
          setRecommendRe = _useState28[1];
      // 更多招工省市
      ...
      resCode === 'own' && recommendRe.length && _taroTt.propsManager.set({
        "data": recommendRe,
        "type": 2,
        "areasId": areasId,
      ...
      !(resCode === 'own') && recommend.length && _taroTt.propsManager.set({
        "data": recommend,
        "type": 1,
        "areasId": areasId,
        "occupations": occupations,
