...
var DetailInfoPage = (_temp2 = _class = function (_Taro$Component) {
  ...
  function DetailInfoPage() {
    ...
    }, _this.$usedState = ["data", "loopArray144", "loopArray145", "$compid__120", "resCode", "editPhone", "IMGCDNURL", "again", "stopHiring", "isCollection", "complaintModal", "textarea", "phone"], _this.anonymousFunc5Map = {}, _this.customComponents = ["WechatNotice", "CollectionRecruitList"], _temp), _possibleConstructorReturn(_this, _ret);
  }
  ...
  _createClass(DetailInfoPage, [{
    ...
    value: function _createData() {
      ...
      var loopArray144 = data.classifyName.map(function (v, i) {
        v = {
      ...
      var loopArray145 = data.view_images.length > 0 ? data.view_images.map(function (v, i) {
        v = {
          $original: (0, _taroWeapp.internal_get_original)(v)
        };
