...
var DetailInfoPage = function (_Taro$Component) {
  ...
  function DetailInfoPage() {
    ...
    _this.$usedState = ["data", "loopArray101", "loopArray102", "$compid__81", "resCode", "editPhone", "SHOWOFFICIALACCOUNT", "DOWNLOADAPP", "IMGCDNURL", "isCollection", "ISCANSHARE", "complaintModal", "phone"];
  ...
  _createClass(DetailInfoPage, [{
    ...
    value: function _createData() {
      ...
      var loopArray101 = data.classifyName.map(function (v, i) {
        v = {
      ...
      var loopArray102 = data.view_images.length ? data.view_images.map(function (v, i) {
        v = {
          $original: (0, _taroTt.internal_get_original)(v)
        };
