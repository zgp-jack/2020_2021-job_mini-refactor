...
var DetailInfoPage = function (_Taro$Component) {
  ...
  function DetailInfoPage() {
    ...
    _this.$usedState = ["data", "loopArray60", "loopArray61", "$compid__56", "$compid__57", "resCode", "editPhone", "IMGCDNURL", "again", "stopHiring", "isCollection", "recommend", "complaintModal", "phone"];
  ...
  _createClass(DetailInfoPage, [{
    ...
    value: function _createData() {
      ...
      var loopArray60 = data.classifyName.map(function (v, i) {
        v = {
      ...
      var loopArray61 = data.view_images.length ? data.view_images.map(function (v, i) {
        v = {
          $original: (0, _taroTt.internal_get_original)(v)
        };
        var $loopState__temp4 = data.view_images.length ? i + i : null;
        var _$indexKey = "hbzzz" + i;
