...
var DetailInfoPage = (_temp2 = _class = function (_Taro$Component) {
  ...
  function DetailInfoPage() {
    ...
    }, _this.$usedState = ["data", "loopArray129", "loopArray130", "resCode", "IMGCDNURL", "again", "stopHiring", "isCollection", "complaintModal", "textarea"], _this.anonymousFunc5Map = {}, _this.customComponents = ["WechatNotice"], _temp), _possibleConstructorReturn(_this, _ret);
  }
  ...
  _createClass(DetailInfoPage, [{
    ...
    value: function _createData() {
      ...
      var loopArray129 = data.classifyName.map(function (v, i) {
        v = {
      ...
      var loopArray130 = data.view_images.length > 0 ? data.view_images.map(function (v, i) {
        v = {
          $original: (0, _taroWeapp.internal_get_original)(v)
        };
