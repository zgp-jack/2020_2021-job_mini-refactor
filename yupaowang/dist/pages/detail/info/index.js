...
var DetailInfoPage = function (_Taro$Component) {
  ...
  function DetailInfoPage() {
    ...
    _this.$usedState = ["anonymousState__temp3", "data", "loopArray74", "loopArray75", "$compid__66", "$compid__67", "$compid__68", "resCode", "editPhone", "SHOWOFFICIALACCOUNT", "SERIES", "QQSERIES", "ios", "DOWNLOADAPP", "IMGCDNURL", "again", "stopHiring", "editTopping", "isCollection", "ISCANSHARE", "recommend", "complaintModal", "phone"];
