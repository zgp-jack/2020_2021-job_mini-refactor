(swan["webpackJsonp"] = swan["webpackJsonp"] || []).push([["pages/information/system/index"],{
...
var System = function (_Taro$Component) {
  ...
  function System() {
    ...
    _this.$usedState = ["data", "loopArray46", "IMGCDNURL", "isDown"];
  ...
  _createClass(System, [{
    ...
    value: function _createData() {
      ...
      var loopArray46 = data.item.map(function (item, __index0) {
        item = {
          privateOriginal: (0, _taroSwan.internal_get_original)(item)
        };
        var _$indexKey = "fczzz" + __index0;
        _this2.anonymousFunc0Map[_$indexKey] = function () {
          return userRouteJump(item.privateOriginal.type);
        };
        return {
...
Page(__webpack_require__(/*! @tarojs/taro-swan */ "./node_modules/@tarojs/taro-swan/index.js").default.createComponent(System, true));
