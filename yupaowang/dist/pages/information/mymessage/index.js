(swan["webpackJsonp"] = swan["webpackJsonp"] || []).push([["pages/information/mymessage/index"],{
...
var Mymessage = function (_Taro$Component) {
  ...
  function Mymessage() {
    ...
    _this.$usedState = ["data", "loopArray45", "IMGCDNURL"];
  ...
  _createClass(Mymessage, [{
    ...
    value: function _createData() {
      ...
      var loopArray45 = data.item.map(function (item, index) {
        item = {
        ...
        _this2.anonymousFunc0Map[_$indexKey] = function () {
          return userRouteJump("/pages/information/system/index?type=" + item.privateOriginal.type);
        };
        return {
...
Page(__webpack_require__(/*! @tarojs/taro-swan */ "./node_modules/@tarojs/taro-swan/index.js").default.createComponent(Mymessage, true));
