...
var Mymessage = (_temp2 = _class = function (_Taro$Component) {
  ...
  function Mymessage() {
    ...
    }, _this.$usedState = ["data", "loopArray89", "IMGCDNURL"], _this.anonymousFunc0Map = {}, _this.customComponents = ["Auth", "Nodata"], _temp), _possibleConstructorReturn(_this, _ret);
  }
  ...
  _createClass(Mymessage, [{
    ...
    value: function _createData() {
      ...
      var loopArray89 = data.item.map(function (item, index) {
        item = {
