...
var Distruction = (_temp2 = _class = function (_Taro$Component) {
  ...
  function Distruction() {
    ...
    }, _this.$usedState = ["searchData", "history", "data", "are", "loopArray123", "loopArray124", "loopArray125", "loopArray126", "clickInput", "inputVal", "onInput", "IMGCDNURL"], _this.anonymousFunc2Map = {}, _this.anonymousFunc4Map = {}, _this.anonymousFunc5Map = {}, _this.anonymousFunc6Map = {}, _this.customComponents = [], _temp), _possibleConstructorReturn(_this, _ret);
  }
  ...
  _createClass(Distruction, [{
    ...
    value: function _createData() {
      ...
      var loopArray123 = searchData.list.length > 0 ? searchData.list.map(function (v, __index2) {
        v = {
          $original: (0, _taroWeapp.internal_get_original)(v)
        };

        var _$indexKey = "baezz" + __index2;
      ...
      var loopArray124 = clickInput && !onInput && history.historylist.length > 0 ? history.historylist.map(function (v, __index4) {
        v = {
          $original: (0, _taroWeapp.internal_get_original)(v)
        };

        var _$indexKey2 = "bafzz" + __index4;
      ...
      var loopArray125 = data.item.map(function (v, __index5) {
        v = {
          $original: (0, _taroWeapp.internal_get_original)(v)
        };
      ...
      var loopArray126 = are.areData.map(function (v, __index7) {
        v = {
          $original: (0, _taroWeapp.internal_get_original)(v)
        };
        var $anonymousCallee__26 = v.$original.children.map(function (val, index) {
          val = {
            $original: (0, _taroWeapp.internal_get_original)(val)
          };
          var _$indexKey4 = 'bahzz' + __index7 + '-' + index;
        ...
        return {
          $anonymousCallee__26: $anonymousCallee__26,
          $original: v.$original
        };
      });
