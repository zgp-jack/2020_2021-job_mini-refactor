...
var Distruction = (_temp2 = _class = function (_Taro$Component) {
  ...
  function Distruction() {
    ...
    }, _this.$usedState = ["searchData", "history", "data", "are", "loopArray134", "loopArray135", "loopArray136", "loopArray137", "clickInput", "inputVal", "onInput", "IMGCDNURL"], _this.anonymousFunc2Map = {}, _this.anonymousFunc4Map = {}, _this.anonymousFunc5Map = {}, _this.anonymousFunc6Map = {}, _this.customComponents = [], _temp), _possibleConstructorReturn(_this, _ret);
  }
  ...
  _createClass(Distruction, [{
    ...
    value: function _createData() {
      ...
      var loopArray134 = searchData.list.length > 0 ? searchData.list.map(function (v, __index2) {
        v = {
      ...
      var loopArray135 = clickInput && !onInput && history.historylist.length > 0 ? history.historylist.map(function (v, __index4) {
        v = {
          $original: (0, _taroWeapp.internal_get_original)(v)
        };
      ...
      var loopArray136 = data.item.map(function (v, __index5) {
        v = {
          $original: (0, _taroWeapp.internal_get_original)(v)
        };
      ...
      var loopArray137 = are.areData.map(function (v, __index7) {
        v = {
          $original: (0, _taroWeapp.internal_get_original)(v)
        };
