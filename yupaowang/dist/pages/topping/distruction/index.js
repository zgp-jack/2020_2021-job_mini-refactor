...
var Distruction = (_temp2 = _class = function (_Taro$Component) {
  ...
  function Distruction() {
    ...
    }, _this.$usedState = ["searchData", "history", "data", "are", "loopArray131", "loopArray132", "loopArray133", "loopArray134", "clickInput", "inputVal", "onInput", "IMGCDNURL"], _this.anonymousFunc2Map = {}, _this.anonymousFunc4Map = {}, _this.anonymousFunc5Map = {}, _this.anonymousFunc6Map = {}, _this.customComponents = [], _temp), _possibleConstructorReturn(_this, _ret);
  }
  ...
  _createClass(Distruction, [{
    ...
    value: function _createData() {
      ...
      var loopArray131 = searchData.list.length > 0 ? searchData.list.map(function (v, __index2) {
        v = {
          $original: (0, _taroWeapp.internal_get_original)(v)
        };

        var _$indexKey = "bchzz" + __index2;
      ...
      var loopArray132 = clickInput && !onInput && history.historylist.length > 0 ? history.historylist.map(function (v, __index4) {
        v = {
          $original: (0, _taroWeapp.internal_get_original)(v)
        };

        var _$indexKey2 = "bcizz" + __index4;
      ...
      var loopArray133 = data.item.map(function (v, __index5) {
        v = {
          $original: (0, _taroWeapp.internal_get_original)(v)
        };

        var _$indexKey3 = "bcjzz" + __index5;
      ...
      var loopArray134 = are.areData.map(function (v, __index7) {
        v = {
          $original: (0, _taroWeapp.internal_get_original)(v)
        };
        var $anonymousCallee__29 = v.$original.children.map(function (val, index) {
          ...
          var _$indexKey4 = 'bdazz' + __index7 + '-' + index;
