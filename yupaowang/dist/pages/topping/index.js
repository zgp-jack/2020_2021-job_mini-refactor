...
var Topping = function (_Taro$Component) {
  ...
  function Topping() {
    ...
    _this.$usedState = ["params", "data", "loopArray77", "loopArray78", "loopArray79", "loopArray80", "loopArray81", "province", "IMGCDNURL", "rec", "basics", "type", "list", "displayTime", "num", "endTime", "editData", "newTime", "day", "SERVERPHONE"];
  ...
  _createClass(Topping, [{
    ...
    value: function _createData() {
      ...
      var loopArray77 = province ? province.map(function (v, __index0) {
        v = {
      ...
      var loopArray78 = params ? params.city.map(function (v, __index1) {
        v = {
          privateOriginal: (0, _taroSwan.internal_get_original)(v)
        };
      ...
      var loopArray79 = params ? params.province.map(function (v, __index2) {
        v = {
          privateOriginal: (0, _taroSwan.internal_get_original)(v)
        };
      ...
      var loopArray80 = params ? params.whole.map(function (v, __index3) {
        v = {
          privateOriginal: (0, _taroSwan.internal_get_original)(v)
        };
      ...
      var loopArray81 = data.top_rules.map(function (v, i) {
        v = {
          privateOriginal: (0, _taroSwan.internal_get_original)(v)
        };
