...
var Index = (_temp2 = _class = function (_Taro$Component) {
  ...
  function Index() {
    ...
    }, _this.$usedState = ["$compid__62", "tabKey", "HOME", "RECRUIT", "RESUME", "MEMBER"], _this.customComponents = ["Home", "Recruit", "Resume", "Member", "Tabbar"], _temp), _possibleConstructorReturn(_this, _ret);
  }
