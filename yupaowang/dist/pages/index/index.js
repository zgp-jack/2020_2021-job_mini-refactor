...
var Index = function (_Taro$Component) {
  ...
  _createClass(Index, [{
    ...
    value: function _createData() {
      ...
      var _genCompid = (0, _taroQq.genCompid)(__prefix + "$compid__16"),
          _genCompid2 = _slicedToArray(_genCompid, 2),
          $prevCompid__16 = _genCompid2[0],
          $compid__16 = _genCompid2[1];

      var _genCompid3 = (0, _taroQq.genCompid)(__prefix + "$compid__17"),
          _genCompid4 = _slicedToArray(_genCompid3, 2),
          $prevCompid__17 = _genCompid4[0],
          $compid__17 = _genCompid4[1];

      var _genCompid5 = (0, _taroQq.genCompid)(__prefix + "$compid__18"),
      ...
      var _useState = (0, _taroQq.useState)(0),
      ...
      (0, _taroQq.useDidShow)(function () {
        // 显示的时候重置当前标题
        if (tabKey) {
          _taroQq2.default.setNavigationBarTitle({ title: _index2.default[tabKey].navigationBarTitleText });
        }
      ...
      (0, _taroQq.useEffect)(function () {
        ...
        _taroQq2.default.setNavigationBarTitle({ title: data.navigationBarTitleText });
        _taroQq2.default.setNavigationBarColor({
          backgroundColor: data.navigationBarBackgroundColor || '#0099ff',
          frontColor: '#ffffff'
        });
      }, [tabKey]);
      tabKey === _tabbar.HOME && _taroQq.propsManager.set({
        "homeIndex": showIndex
      }, $compid__16, $prevCompid__16);
      tabKey === _tabbar.MEMBER && _taroQq.propsManager.set({
