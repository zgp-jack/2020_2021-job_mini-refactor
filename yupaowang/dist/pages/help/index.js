...
var Help = function (_Taro$Component) {
  ...
  function Help() {
    ...
    _this.$usedState = ["data", "loopArray60", "refresh", "isDown"];
  ...
  _createClass(Help, [{
    ...
    value: function _createData() {
      ...
      var loopArray60 = data.item.map(function (item, __index2) {
        item = {
          $original: (0, _taroWeapp.internal_get_original)(item)
        };
        var $loopState__temp2 = { value: 'help', color: '#09f', size: '15' };
        var _$indexKey = "gizzz" + __index2;
        _this2.anonymousFunc2Map[_$indexKey] = function () {
          handleShow(item.$original.id);
        };

        var _genCompid = (0, _taroWeapp.genCompid)(__prefix + "gjzzzzzzzz" + __index2, true),
        ...
        var _genCompid3 = (0, _taroWeapp.genCompid)(__prefix + "hazzzzzzzz" + __index2, true),
