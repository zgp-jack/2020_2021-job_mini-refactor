...
var Help = function (_Taro$Component) {
  ...
  function Help() {
    ...
    _this.$usedState = ["data", "loopArray59", "refresh", "isDown"];
  ...
  _createClass(Help, [{
    ...
    value: function _createData() {
      ...
      var loopArray59 = data.item.map(function (item, __index2) {
        item = {
          $original: (0, _taroTt.internal_get_original)(item)
        };
        var $loopState__temp2 = { value: 'help', color: '#09f', size: '15' };
        var _$indexKey = "ghzzz" + __index2;
        _this2.anonymousFunc2Map[_$indexKey] = function () {
          handleShow(item.$original.id);
        };

        var _genCompid = (0, _taroTt.genCompid)(__prefix + "gizzzzzzzz" + __index2, true),
        ...
        var _genCompid3 = (0, _taroTt.genCompid)(__prefix + "gjzzzzzzzz" + __index2, true),
