...
var Help = (_temp2 = _class = function (_Taro$Component) {
  ...
  function Help() {
    ...
    }, _this.$usedState = ["data", "loopArray78", "refresh", "isDown"], _this.anonymousFunc2Map = {}, _this.customComponents = ["Nodata", "AtAccordion", "AtList"], _temp), _possibleConstructorReturn(_this, _ret);
  }
  ...
  _createClass(Help, [{
    ...
    value: function _createData() {
      ...
      var loopArray78 = data.item.map(function (item, __index2) {
        item = {
        ...
        var _genCompid = (0, _taroWeapp.genCompid)(__prefix + "hczzzzzzzz" + __index2, true),
        ...
        var _genCompid3 = (0, _taroWeapp.genCompid)(__prefix + "hdzzzzzzzz" + __index2, true),
