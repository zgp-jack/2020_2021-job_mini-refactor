...
var Help = function (_Taro$Component) {
  ...
  function Help() {
    ...
    _this.$usedState = ["data", "loopArray52", "refresh", "isDown"];
  ...
  _createClass(Help, [{
    ...
    value: function _createData() {
      ...
      var loopArray52 = data.item.map(function (item, __index2) {
        item = {
        ...
        var _genCompid = (0, _taroTt.genCompid)(__prefix + "gdzzzzzzzz" + __index2, true),
        ...
        var _genCompid3 = (0, _taroTt.genCompid)(__prefix + "gezzzzzzzz" + __index2, true),
