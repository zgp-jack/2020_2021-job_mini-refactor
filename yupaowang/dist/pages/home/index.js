...
var Home = function (_Taro$Component) {
  ...
  _createClass(Home, [{
    ...
    value: function _createData() {
      ...
      var _genCompid7 = (0, _taroWeapp.genCompid)(__prefix + "$compid__8"),
          _genCompid8 = _slicedToArray(_genCompid7, 2),
          $prevCompid__8 = _genCompid8[0],
          $compid__8 = _genCompid8[1];

      var _genCompid9 = (0, _taroWeapp.genCompid)(__prefix + "$compid__9"),
          _genCompid10 = _slicedToArray(_genCompid9, 2),
          $prevCompid__9 = _genCompid10[0],
          $compid__9 = _genCompid10[1];

      var _genCompid11 = (0, _taroWeapp.genCompid)(__prefix + "$compid__10"),
          _genCompid12 = _slicedToArray(_genCompid11, 2),
          $prevCompid__10 = _genCompid12[0],
          $compid__10 = _genCompid12[1];

      var userChooseCity = _taroWeapp2.default.getStorageSync(_store.UserListChooseCity);
      var location = _taroWeapp2.default.getStorageSync(_store.UserLocation);
      // 当前展示的城市
