...
var Home = function (_Taro$Component) {
  ...
  function Home() {
    ...
    _this.$usedState = ["anonymousState__temp", "anonymousState__temp2", "$compid__7", "$compid__8", "$compid__9", "$compid__10", "$compid__11", "$compid__12", "IMGCDNURL", "ISWEIXIN", "shwoCity", "area"];
