(qq["webpackJsonp"] = qq["webpackJsonp"] || []).push([["pages/home/index"],{
...
var Home = function (_Taro$Component) {
  ...
  _createClass(Home, [{
    ...
    value: function _createData() {
      ...
      var _genCompid3 = (0, _taroQq.genCompid)(__prefix + "$compid__20"),
          _genCompid4 = _slicedToArray(_genCompid3, 2),
          $prevCompid__20 = _genCompid4[0],
          $compid__20 = _genCompid4[1];

      var _genCompid5 = (0, _taroQq.genCompid)(__prefix + "$compid__21"),
          _genCompid6 = _slicedToArray(_genCompid5, 2),
          $prevCompid__21 = _genCompid6[0],
          $compid__21 = _genCompid6[1];

      var _genCompid7 = (0, _taroQq.genCompid)(__prefix + "$compid__22"),
          _genCompid8 = _slicedToArray(_genCompid7, 2),
          $prevCompid__22 = _genCompid8[0],
          $compid__22 = _genCompid8[1];

      var _genCompid9 = (0, _taroQq.genCompid)(__prefix + "$compid__23"),
          _genCompid10 = _slicedToArray(_genCompid9, 2),
          $prevCompid__23 = _genCompid10[0],
          $compid__23 = _genCompid10[1];

      var _genCompid11 = (0, _taroQq.genCompid)(__prefix + "$compid__24"),
      ...
      (0, _taroQq.useEffect)(function () {
        userChooseCity = _taroQq2.default.getStorageSync(_store.UserListChooseCity);
        location = _taroQq2.default.getStorageSync(_store.UserLocation);
      ...
      var _useState = (0, _taroQq.useState)(userChooseCity ? userChooseCity.name : '全国'),
      ...
      shwoCity && _taroQq.propsManager.set({
        "show": shwoCity,
...
Component(__webpack_require__(/*! @tarojs/taro-qq */ "./node_modules/@tarojs/taro-qq/index.js").default.createComponent(Home));
