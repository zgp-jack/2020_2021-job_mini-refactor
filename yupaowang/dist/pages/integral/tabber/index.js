...
var Tabber = (_temp2 = _class = function (_Taro$Component) {
  ...
  function Tabber() {
    ...
    }, _this.$usedState = ["data", "modalData", "loopArray127", "loopArray128", "$compid__113", "time", "start", "end", "IMGCDNURL", "initInfo", "sourceList", "consumeList", "startType", "modal", "complaintModal", "textarea", "showTime", "title", "num"], _this.anonymousFunc3Map = {}, _this.customComponents = ["Nodata"], _temp), _possibleConstructorReturn(_this, _ret);
  }
  ...
  _createClass(Tabber, [{
    ...
    value: function _createData() {
      ...
      var loopArray127 = data.lists.map(function (item, index) {
        item = {
      ...
      var loopArray128 = initInfo === '1' && modal && modalData ? modalData.classifyName.map(function (v, i) {
        v = {
