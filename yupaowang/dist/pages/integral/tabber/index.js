...
var Tabber = function (_Taro$Component) {
  ...
  function Tabber() {
    ...
    _this.$usedState = ["data", "modalData", "loopArray73", "$compid__64", "$compid__65", "time", "start", "end", "IMGCDNURL", "initInfo", "sourceList", "consumeList", "startType", "modal", "complaintModal", "showTime", "title", "num"];
