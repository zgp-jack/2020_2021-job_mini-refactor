...
var Tabber = function (_Taro$Component) {
  ...
  function Tabber() {
    ...
    _this.$usedState = ["data", "modalData", "loopArray71", "$compid__65", "$compid__66", "time", "start", "end", "IMGCDNURL", "initInfo", "sourceList", "consumeList", "startType", "modal", "complaintModal", "showTime", "title", "num"];
