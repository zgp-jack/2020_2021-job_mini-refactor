(qq["webpackJsonp"] = qq["webpackJsonp"] || []).push([["pages/integral/tabber/index"],{
...
var Tabber = function (_Taro$Component) {
  ...
  function Tabber() {
    ...
    _this.$usedState = ["data", "modalData", "loopArray73", "$compid__64", "$compid__65", "SERIES", "QQSERIES", "ios", "time", "IMGCDNURL", "start", "end", "initInfo", "sourceList", "consumeList", "startType", "modal", "complaintModal", "showTime", "title", "num"];
  ...
  _createClass(Tabber, [{
    ...
    value: function _createData() {
      ...
      var _genCompid = (0, _taroQq.genCompid)(__prefix + "$compid__64"),
          _genCompid2 = _slicedToArray(_genCompid, 2),
          $prevCompid__64 = _genCompid2[0],
          $compid__64 = _genCompid2[1];

      var _genCompid3 = (0, _taroQq.genCompid)(__prefix + "$compid__65"),
      ...
      var _useState5 = (0, _taroQq.useState)(info),
      ...
      var _useState7 = (0, _taroQq.useState)([]),
      ...
      var _useState9 = (0, _taroQq.useState)(''),
      ...
      var _useState13 = (0, _taroQq.useState)(''),
      ...
      var _useState15 = (0, _taroQq.useState)(''),
      ...
      var _useState17 = (0, _taroQq.useState)(''),
      ...
      var _useState19 = (0, _taroQq.useState)('0'),
      ...
      var _useState31 = (0, _taroQq.useState)(false),
      ...
      var _useState35 = (0, _taroQq.useState)(''),
      ...
      var _useState37 = (0, _taroQq.useState)({
        y: '0',
        m: '0',
        stime: '0',
        type: 0,
      ...
      var _useState39 = (0, _taroQq.useState)(false),
      ...
      var _useState41 = (0, _taroQq.useState)({
        time: '',
        sortType: '0',
        flag: false,
        listType: '0'
      ...
      var _useState43 = (0, _taroQq.useState)({
        time: '',
        sortType: '0',
        flag: false,
        listType: '0'
      ...
      var _useState45 = (0, _taroQq.useState)(0),
      ...
      var _useState47 = (0, _taroQq.useState)([]),
      ...
      var _useState49 = (0, _taroQq.useState)([]),
      ...
      var _useState51 = (0, _taroQq.useState)(false),
      ...
      var _useState53 = (0, _taroQq.useState)(false),
      ...
      var _useState55 = (0, _taroQq.useState)(false),
      ...
      (0, _taroQq.useEffect)(function () {
        ...
        _taroQq2.default.setNavigationBarTitle({ title: navigationBarTitleText });
        // 如果用户没有登录 直接断掉请求
        if (!login) {
          return;
        } // 获取现在时间
      ...
      this.anonymousFunc5 = function () {
        _taroQq2.default.makePhoneCall({ phoneNumber: modalData.user_mobile });
      };
      this.anonymousFunc6 = function () {
        return handleComplaint(modalData.id);
      };
      var loopArray73 = initInfo === '1' && modal && modalData ? modalData.classifyName.map(function (v, i) {
        v = {
      ...
      !data.lists.length && _taroQq.propsManager.set({
...
Component(__webpack_require__(/*! @tarojs/taro-qq */ "./node_modules/@tarojs/taro-qq/index.js").default.createComponent(Tabber, true));
