...
var InvitePage = function (_Taro$Component) {
  ...
  function InvitePage() {
    ...
    _this.$usedState = ["tab", "loopArray65", "loopArray66", "$compid__63", "scrollLeft", "list", "pull"];
  ...
  _createClass(InvitePage, [{
    ...
    value: function _createData() {
      ...
      var loopArray65 = tab.item ? tab.item.map(function (item, i) {
        item = {
      ...
      var loopArray66 = list ? list.map(function (v, __index2) {
        v = {
          $original: (0, _taroTt.internal_get_original)(v)
        };
        var _$indexKey2 = "hizzz" + __index2;
