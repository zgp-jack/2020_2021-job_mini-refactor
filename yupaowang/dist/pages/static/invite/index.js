...
var InvitePage = function (_Taro$Component) {
  ...
  function InvitePage() {
    ...
    _this.$usedState = ["tab", "loopArray43", "loopArray44", "$compid__48", "scrollLeft", "list", "pull"];
  ...
  _createClass(InvitePage, [{
    ...
    value: function _createData() {
      ...
      var _useState5 = (0, _taroSwan.useState)('暂无相关资讯'),
      ...
      var handleTable = function handleTable(id, name, index) {
        ...
        setInitPage({ page: 1 });
        setPull(true);
        _taroSwan2.default.pageScrollTo({
          scrollTop: 0
        });
      };
      ...
      var loopArray43 = tab.item ? tab.item.map(function (item, i) {
        item = {
          privateOriginal: (0, _taroSwan.internal_get_original)(item)
        };
        var _$indexKey = "ejzzz" + i;
        _this2.anonymousFunc1Map[_$indexKey] = function () {
          handleTable(item.privateOriginal.index, item.privateOriginal.name, i);
        };
        var loopState__temp2 = tab.item ? (0, _classnames2.default)({
          'invite-tab-active': item.privateOriginal.index === current
        }) : null;
        return {
      ...
      var loopArray44 = list ? list.map(function (v, __index2) {
        v = {
          privateOriginal: (0, _taroSwan.internal_get_original)(v)
        };
        var _$indexKey2 = "fazzz" + __index2;
        _this2.anonymousFunc2Map[_$indexKey2] = function () {
          return userRouteJump("/subpackage/pages/notice/index?id=" + v.privateOriginal.id);
        };
        return {
      ...
      !list.length && _taroSwan.propsManager.set({
        "text": noData
...
Page(__webpack_require__(/*! @tarojs/taro-swan */ "./node_modules/@tarojs/taro-swan/index.js").default.createComponent(InvitePage, true));
