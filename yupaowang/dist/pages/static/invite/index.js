...
var InvitePage = function (_Taro$Component) {
  ...
  function InvitePage() {
    ...
    _this.$usedState = ["tab", "loopArray61", "loopArray62", "$compid__59", "scrollLeft", "list", "pull"];
  ...
  _createClass(InvitePage, [{
    ...
    value: function _createData() {
      ...
      var loopArray61 = tab.item ? tab.item.map(function (item, i) {
        item = {
      ...
      var loopArray62 = list ? list.map(function (v, __index2) {
        v = {
          $original: (0, _taroTt.internal_get_original)(v)
        };
        var _$indexKey2 = "hczzz" + __index2;
