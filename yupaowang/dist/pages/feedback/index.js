...
var Feedback = function (_Taro$Component) {
  ...
  _createClass(Feedback, [{
    ...
    value: function _createData() {
      ...
      var _genCompid5 = (0, _taroTt.genCompid)(__prefix + "$compid__61"),
          _genCompid6 = _slicedToArray(_genCompid5, 2),
          $prevCompid__61 = _genCompid6[0],
          $compid__61 = _genCompid6[1];

      var _genCompid7 = (0, _taroTt.genCompid)(__prefix + "$compid__62"),
          _genCompid8 = _slicedToArray(_genCompid7, 2),
          $prevCompid__62 = _genCompid8[0],
          $compid__62 = _genCompid8[1];

      var _genCompid9 = (0, _taroTt.genCompid)(__prefix + "$compid__63"),
