...
var Feedback = function (_Taro$Component) {
  ...
  function Feedback() {
    ...
    _this.$usedState = ["$compid__54", "$compid__55", "$compid__56", "$compid__57", "$compid__58", "textarea", "image", "isShow", "disabled", "text"];
  ...
  _createClass(Feedback, [{
    ...
    value: function _createData() {
      ...
      var _genCompid5 = (0, _taroTt.genCompid)(__prefix + "$compid__56"),
          _genCompid6 = _slicedToArray(_genCompid5, 2),
          $prevCompid__56 = _genCompid6[0],
          $compid__56 = _genCompid6[1];

      var _genCompid7 = (0, _taroTt.genCompid)(__prefix + "$compid__57"),
          _genCompid8 = _slicedToArray(_genCompid7, 2),
          $prevCompid__57 = _genCompid8[0],
          $compid__57 = _genCompid8[1];

      var _genCompid9 = (0, _taroTt.genCompid)(__prefix + "$compid__58"),
