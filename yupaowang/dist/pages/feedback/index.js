...
var Feedback = function (_Taro$Component) {
  ...
  function Feedback() {
    ...
    _this.$usedState = ["$compid__48", "$compid__49", "$compid__50", "$compid__51", "$compid__52", "textarea", "image", "isShow", "disabled", "text"];
  ...
  _createClass(Feedback, [{
    ...
    value: function _createData() {
      ...
      var _genCompid3 = (0, _taroTt.genCompid)(__prefix + "$compid__49"),
          _genCompid4 = _slicedToArray(_genCompid3, 2),
          $prevCompid__49 = _genCompid4[0],
          $compid__49 = _genCompid4[1];

      var _genCompid5 = (0, _taroTt.genCompid)(__prefix + "$compid__50"),
          _genCompid6 = _slicedToArray(_genCompid5, 2),
          $prevCompid__50 = _genCompid6[0],
          $compid__50 = _genCompid6[1];

      var _genCompid7 = (0, _taroTt.genCompid)(__prefix + "$compid__51"),
          _genCompid8 = _slicedToArray(_genCompid7, 2),
          $prevCompid__51 = _genCompid8[0],
          $compid__51 = _genCompid8[1];

      var _genCompid9 = (0, _taroTt.genCompid)(__prefix + "$compid__52"),
