...
var Feedback = function (_Taro$Component) {
  ...
  function Feedback() {
    ...
    _this.$usedState = ["$compid__61", "$compid__62", "$compid__63", "$compid__64", "$compid__65", "textarea", "image", "isShow", "disabled", "text"];
  ...
  _createClass(Feedback, [{
    ...
    value: function _createData() {
      ...
      var _genCompid5 = (0, _taroTt.genCompid)(__prefix + "$compid__63"),
          _genCompid6 = _slicedToArray(_genCompid5, 2),
          $prevCompid__63 = _genCompid6[0],
          $compid__63 = _genCompid6[1];

      var _genCompid7 = (0, _taroTt.genCompid)(__prefix + "$compid__64"),
          _genCompid8 = _slicedToArray(_genCompid7, 2),
          $prevCompid__64 = _genCompid8[0],
          $compid__64 = _genCompid8[1];

      var _genCompid9 = (0, _taroTt.genCompid)(__prefix + "$compid__65"),
          _genCompid10 = _slicedToArray(_genCompid9, 2),
          $prevCompid__65 = _genCompid10[0],
          $compid__65 = _genCompid10[1];
