...
var Feedback = (_temp2 = _class = function (_Taro$Component) {
  ...
  function Feedback() {
    ...
    }, _this.$usedState = ["$compid__64", "$compid__65", "$compid__66", "$compid__67", "$compid__68", "textarea", "image", "isShow", "disabled", "text"], _this.customComponents = ["WechatNotice", "WordsTotal", "ImageView", "AtInput"], _temp), _possibleConstructorReturn(_this, _ret);
  }
