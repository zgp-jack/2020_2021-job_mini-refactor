...
var Feedback = function (_Taro$Component) {
  ...
  function Feedback() {
    ...
    _this.$usedState = ["$compid__43", "$compid__44", "$compid__45", "$compid__46", "$compid__47", "textarea", "image", "isShow", "disabled", "text"];
  ...
  _createClass(Feedback, [{
    ...
    value: function _createData() {
      ...
      var _genCompid7 = (0, _taroSwan.genCompid)(__prefix + "$compid__46"),
          _genCompid8 = _slicedToArray(_genCompid7, 2),
          $prevCompid__46 = _genCompid8[0],
          $compid__46 = _genCompid8[1];

      var _genCompid9 = (0, _taroSwan.genCompid)(__prefix + "$compid__47"),
