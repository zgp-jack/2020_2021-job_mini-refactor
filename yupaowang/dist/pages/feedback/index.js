(qq["webpackJsonp"] = qq["webpackJsonp"] || []).push([["pages/feedback/index"],{
...
var Feedback = function (_Taro$Component) {
  ...
  _createClass(Feedback, [{
    ...
    value: function _createData() {
      ...
      var _genCompid = (0, _taroQq.genCompid)(__prefix + "$compid__59"),
          _genCompid2 = _slicedToArray(_genCompid, 2),
          $prevCompid__59 = _genCompid2[0],
          $compid__59 = _genCompid2[1];

      var _genCompid3 = (0, _taroQq.genCompid)(__prefix + "$compid__60"),
          _genCompid4 = _slicedToArray(_genCompid3, 2),
          $prevCompid__60 = _genCompid4[0],
          $compid__60 = _genCompid4[1];

      var _genCompid5 = (0, _taroQq.genCompid)(__prefix + "$compid__61"),
          _genCompid6 = _slicedToArray(_genCompid5, 2),
          $prevCompid__61 = _genCompid6[0],
          $compid__61 = _genCompid6[1];

      var _genCompid7 = (0, _taroQq.genCompid)(__prefix + "$compid__62"),
          _genCompid8 = _slicedToArray(_genCompid7, 2),
          $prevCompid__62 = _genCompid8[0],
          $compid__62 = _genCompid8[1];

      var _genCompid9 = (0, _taroQq.genCompid)(__prefix + "$compid__63"),
      ...
      var _useState = (0, _taroQq.useState)(username),
      ...
      var _useState3 = (0, _taroQq.useState)(phone),
      ...
      image.item && _taroQq.propsManager.set({
        "images": image.item,
        "max": 9,
      ...
      isShow && _taroQq.propsManager.set({
        "clear": true,
        "title": "\u9A8C\u8BC1\u7801",
        "type": "text",
        "maxLength": 4,
...
Component(__webpack_require__(/*! @tarojs/taro-qq */ "./node_modules/@tarojs/taro-qq/index.js").default.createComponent(Feedback, true));
