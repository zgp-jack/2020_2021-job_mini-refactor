...
var Feedback = (_temp2 = _class = function (_Taro$Component) {
  ...
  function Feedback() {
    ...
    }, _this.$usedState = ["$compid__68", "$compid__69", "$compid__70", "$compid__71", "$compid__72", "textarea", "image", "isShow", "disabled", "text"], _this.customComponents = ["WechatNotice", "WordsTotal", "ImageView", "AtInput"], _temp), _possibleConstructorReturn(_this, _ret);
  }
