...
var Recharge = (_temp2 = _class = function (_Taro$Component) {
  ...
  function Recharge() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = Recharge.__proto__ || Object.getPrototypeOf(Recharge)).call.apply(_ref, [this].concat(args))), _this), _this.$usedState = ["loopArray72", "lists", "integral", "current", "price"], _this.anonymousFunc0Map = {}, _this.customComponents = ["AtMessage"], _temp), _possibleConstructorReturn(_this, _ret);
  }
  ...
  _createClass(Recharge, [{
    ...
    value: function _createData() {
      ...
      var loopArray72 = lists.map(function (item, index) {
        item = {
