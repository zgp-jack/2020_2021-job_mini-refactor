...
var RecruitMap = (_temp2 = _class = function (_Taro$Component) {
  ...
  function RecruitMap() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = RecruitMap.__proto__ || Object.getPrototypeOf(RecruitMap)).call.apply(_ref, [this].concat(args))), _this), _this.$usedState = ["$compid__81"], _this.customComponents = ["MapComponent"], _temp), _possibleConstructorReturn(_this, _ret);
  }
