...
var RecruitMap = (_temp2 = _class = function (_Taro$Component) {
  ...
  function RecruitMap() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = RecruitMap.__proto__ || Object.getPrototypeOf(RecruitMap)).call.apply(_ref, [this].concat(args))), _this), _this.$usedState = ["$compid__595"], _this.customComponents = ["MapComponent"], _temp), _possibleConstructorReturn(_this, _ret);
  }
  ...
  _createClass(RecruitMap, [{
    ...
    value: function _createData() {
      ...
      var _genCompid = (0, _taroWeapp.genCompid)(__prefix + "$compid__595"),
          _genCompid2 = _slicedToArray(_genCompid, 2),
          $prevCompid__595 = _genCompid2[0],
          $compid__595 = _genCompid2[1];
  ...
  return RecruitMap;
}(_taroWeapp2.default.Component), _class.$$events = [], _class.$$componentPath = "pages/map/recruit/index", _temp2);
