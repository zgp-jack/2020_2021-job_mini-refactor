...
var RecruitMap = function (_Taro$Component) {
  ...
  function RecruitMap() {
    ...
    _this.$usedState = ["loopArray30", "loopArray31", "$compid__31", "smAreaText", "showHistory", "histroyList", "lists", "IMGCDNURL", "showCity", "area"];
  ...
  _createClass(RecruitMap, [{
    ...
    value: function _createData() {
      ...
      var _genCompid = (0, _taroTt.genCompid)(__prefix + "$compid__31"),
      ...
      var _useContext = (0, _taroTt.useContext)(_index.context),
      ...
      var loopArray30 = showHistory ? histroyList.map(function (item, index) {
        item = {
      ...
      var loopArray31 = lists.map(function (item, index) {
        item = {
          $original: (0, _taroTt.internal_get_original)(item)
        };
