(qq["webpackJsonp"] = qq["webpackJsonp"] || []).push([["pages/map/resume/index"],{
...
var contextItem = exports.contextItem = (0, _taroQq.createContext)({});
...
var ResumeMap = function (_Taro$Component) {
  ...
  _createClass(ResumeMap, [{
    ...
    value: function _createData() {
      ...
      var _genCompid = (0, _taroQq.genCompid)(__prefix + "$compid__51"),
      ...
      var _useState = (0, _taroQq.useState)(provinceAdress),
          _useState2 = _slicedToArray(_useState, 2),
          area = _useState2[0],
          setArea = _useState2[1];

      var _useState3 = (0, _taroQq.useState)(provinceAdressName),
      ...
      var _useState11 = (0, _taroQq.useState)(false),
      ...
      (0, _taroQq.useEffect)(function () {
        var areas = _taroQq2.default.getStorageSync(_store.Areas);
        if (areas) {
          setAreas(areas);
        } else (0, _index.getAllAreas)().then(function (res) {
          // 存入缓存
          _taroQq2.default.setStorageSync(_store.Areas, res);
          setAreas(res);
        });
      }, []);
      // 初始化用户定位信息
      var initUserLocationCity = function initUserLocationCity() {
        var userLoc = _taroQq2.default.getStorageSync(_store.UserLocationCity);
        if (userLoc) {
      ...
      (0, _taroQq.useEffect)(function () {
        ...
        (0, _index3.getAmapPoiList)(areaName + smAreaText).then(function (data) {
          var loc = _taroQq2.default.getStorageSync(_store.UserLocation);
      ...
      var setUserPublishAreaHistoryItem = function setUserPublishAreaHistoryItem(item) {
        var userPublishAreaHistory = _taroQq2.default.getStorageSync(_store.UserPublishAreaHistory);
        if (userPublishAreaHistory) {
          ...
          _taroQq2.default.setStorageSync(_store.UserPublishAreaHistory, userPublishAreaHistory);
        } else {
          setHistoryList([item]);
          _taroQq2.default.setStorageSync(_store.UserPublishAreaHistory, [item]);
        }
      };
      // 初始化用户点击小地区的历史记录
      ...
      showCity && _taroQq.propsManager.set({
        "data": areas,
        "area": area,
        "userLoc": userLoc,
...
Component(__webpack_require__(/*! @tarojs/taro-qq */ "./node_modules/@tarojs/taro-qq/index.js").default.createComponent(ResumeMap, true));
