...
var RealnameMap = function (_Taro$Component) {
  ...
  function RealnameMap() {
    ...
    _this.$usedState = ["loopArray61", "loopArray62", "$compid__54", "smAreaText", "showHistory", "histroyList", "lists", "IMGCDNURL", "showCity", "area"];
  ...
  _createClass(RealnameMap, [{
    ...
    value: function _createData() {
      ...
      var _useState = (0, _taroWeapp.useState)(RealnameAreaRedux.RealnameArea),
