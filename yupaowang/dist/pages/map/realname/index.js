...
var RealnameMap = function (_Taro$Component) {
  ...
  function RealnameMap() {
    ...
    _this.$usedState = ["loopArray54", "loopArray55", "$compid__44", "smAreaText", "showHistory", "histroyList", "lists", "IMGCDNURL", "showCity", "area"];
  ...
  _createClass(RealnameMap, [{
    ...
    value: function _createData() {
      ...
      var loopArray54 = showHistory ? histroyList.map(function (item, index) {
        item = {
