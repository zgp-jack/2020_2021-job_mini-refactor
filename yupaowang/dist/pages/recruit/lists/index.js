...
var Recruit = function (_Taro$Component) {
  ...
  function Recruit() {
    ...
    _this.$usedState = ["anonymousState__temp", "anonymousState__temp2", "anonymousState__temp3", "anonymousState__temp4", "$compid__12", "$compid__13", "$compid__14", "scrollTop", "refresh"];
  ...
  _createClass(Recruit, [{
    ...
    value: function _createData() {
      ...
      var _genCompid3 = (0, _taroTt.genCompid)(__prefix + "$compid__13"),
          _genCompid4 = _slicedToArray(_genCompid3, 2),
          $prevCompid__13 = _genCompid4[0],
          $compid__13 = _genCompid4[1];

      var _genCompid5 = (0, _taroTt.genCompid)(__prefix + "$compid__14"),
