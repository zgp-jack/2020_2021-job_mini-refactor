(qq["webpackJsonp"] = qq["webpackJsonp"] || []).push([["pages/recruit/lists/index"],{
...
var Recruit = function (_Taro$Component) {
  ...
  _createClass(Recruit, [{
    ...
    value: function _createData() {
      ...
      var _genCompid = (0, _taroQq.genCompid)(__prefix + "$compid__29"),
          _genCompid2 = _slicedToArray(_genCompid, 2),
          $prevCompid__29 = _genCompid2[0],
          $compid__29 = _genCompid2[1];

      var _genCompid3 = (0, _taroQq.genCompid)(__prefix + "$compid__30"),
          _genCompid4 = _slicedToArray(_genCompid3, 2),
          $prevCompid__30 = _genCompid4[0],
          $compid__30 = _genCompid4[1];

      var _genCompid5 = (0, _taroQq.genCompid)(__prefix + "$compid__31"),
      ...
      var _useState3 = (0, _taroQq.useState)(true),
      ...
      var userListChooseCity = _taroQq2.default.getStorageSync(_store.UserListChooseCity);
      // * 配置筛选条件

      var _useState5 = (0, _taroQq.useState)([{ id: _lists.AreaPickerKey, text: userListChooseCity ? userListChooseCity.name : '全国' }, { id: _lists.ClassifyPickerKey, text: '全部分类' }, { id: _lists.FilterPickerKey, text: '最新' }]),
      ...
      var resetLocationSearch = function resetLocationSearch(data) {
        ...
        _taroQq2.default.setStorageSync(_store.UserListChooseCity, city); //第一次默认选中
        setLists([]);
      ...
      var getUserLocation = function getUserLocation() {
        ...
        if (userListChooseCity) {
          ...
          var userLocationCity = _taroQq2.default.getStorageSync(_store.UserLocationCity);
          if (userLocationCity) {
          ...
          (0, _index2.userAuthLoction)().then(function (gpsLocation) {
            ...
            // 拒绝授权默认全国
            _taroQq2.default.setStorageSync(_store.UserListChooseCity, _area.AREACHINA);
            setLists([]);
      ...
      var getNextPageData = function getNextPageData() {
        ...
        _taroQq2.default.showNavigationBarLoading();
      ...
      var userPublishRecruit = function userPublishRecruit() {
        _taroQq2.default.navigateTo({ url: _index3.PUBLISHRECRUIT });
      };
      // * 更新筛选条件
      ...
      var anonymousState__temp4 = (0, _taroQq.internal_inline_style)({ height: '8px' });
...
Component(__webpack_require__(/*! @tarojs/taro-qq */ "./node_modules/@tarojs/taro-qq/index.js").default.createComponent(Recruit));
