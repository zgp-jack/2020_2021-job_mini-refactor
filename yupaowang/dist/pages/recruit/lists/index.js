...
var Recruit = function (_Taro$Component) {
  ...
  function Recruit() {
    ...
    _this.$usedState = ["anonymousState__temp", "$compid__10", "$compid__11", "$compid__12", "refresh"];
  ...
  _createClass(Recruit, [{
    ...
    value: function _createData() {
      ...
      var _useState = (0, _taroSwan.useState)([{ id: 'area', text: userListChooseCity ? userListChooseCity.name : '全国' }, { id: 'work', text: '选择工种' }, { id: 'filter', text: '最新' }]),
      ...
      var userPublishRecruit = function userPublishRecruit() {
        _taroSwan2.default.navigateTo({ url: '/pages/recruit/publish/index' });
      };
      ...
      var anonymousState__temp = (0, _taroSwan.internal_inline_style)({ height: '8px' });
