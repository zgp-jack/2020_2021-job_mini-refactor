(qq["webpackJsonp"] = qq["webpackJsonp"] || []).push([["pages/recruit/publish/index"],{
...
function usePublishViewInfo(InitParams) {
  ...
  var _useState13 = (0, _taroQq.useState)([0, 0]),
  ...
  function initUserAreaInfo(data) {
    ...
    if (InitParams.infoId) {
      ...
      var userLoctionCity = _taroQq2.default.getStorageSync(_store.UserLocationCity);
      if (userLoctionCity) {
    ...
    if (InitParams.infoId) {
      ...
      // 获取用户最后发布的区域信息
      var userLastPublishArea = _taroQq2.default.getStorageSync(_store.UserLastPublishArea);
...
var PublishRecruit = function (_Taro$Component) {
  ...
  _createClass(PublishRecruit, [{
    ...
    value: function _createData() {
      ...
      var _genCompid3 = (0, _taroQq.genCompid)(__prefix + "$compid__44"),
...
Component(__webpack_require__(/*! @tarojs/taro-qq */ "./node_modules/@tarojs/taro-qq/index.js").default.createComponent(PublishRecruit, true));
