...
var PublishedRecruit = function (_Taro$Component) {
  ...
  function PublishedRecruit() {
    ...
    _this.$usedState = ["loopArray36", "loopArray37", "HeaderList", "refresh", "lists", "IMGCDNURL", "more", "searchData"];
  ...
  _createClass(PublishedRecruit, [{
    ...
    value: function _createData() {
      ...
      var loopArray36 = _config2.default.map(function (item, __index0) {
        item = {
          privateOriginal: (0, _taroSwan.internal_get_original)(item)
        };
        var _$indexKey = "ddzzz" + __index0;
