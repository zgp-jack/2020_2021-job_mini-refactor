...
var PublishedRecruit = (_temp2 = _class = function (_Taro$Component) {
  ...
  function PublishedRecruit() {
    ...
    }, _this.$usedState = ["loopArray113", "loopArray114", "HeaderList", "refresh", "lists", "IMGCDNURL", "more", "searchData"], _this.anonymousFunc0Map = {}, _this.anonymousFunc3Map = {}, _this.anonymousFunc4Map = {}, _this.anonymousFunc5Map = {}, _this.anonymousFunc6Map = {}, _this.anonymousFunc7Map = {}, _this.customComponents = ["Nodata"], _temp), _possibleConstructorReturn(_this, _ret);
  }
  ...
  _createClass(PublishedRecruit, [{
    ...
    value: function _createData() {
      ...
      var loopArray113 = _config2.default.map(function (item, __index0) {
        item = {
      ...
      var loopArray114 = lists.map(function (item, index) {
        item = {
          $original: (0, _taroWeapp.internal_get_original)(item)
        };
