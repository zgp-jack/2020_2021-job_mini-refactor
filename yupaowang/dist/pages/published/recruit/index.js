...
var PublishedRecruit = function (_Taro$Component) {
  ...
  function PublishedRecruit() {
    ...
    _this.$usedState = ["loopArray52", "loopArray53", "HeaderList", "refresh", "lists", "IMGCDNURL", "more", "searchData"];
  ...
  _createClass(PublishedRecruit, [{
    ...
    value: function _createData() {
      ...
      var loopArray52 = _config2.default.map(function (item, __index0) {
        item = {
          $original: (0, _taroTt.internal_get_original)(item)
        };
        var _$indexKey = "fazzz" + __index0;
