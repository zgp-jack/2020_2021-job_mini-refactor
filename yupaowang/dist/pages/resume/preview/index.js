...
var Preview = function (_Taro$Component) {
  ...
  function Preview() {
    ...
    _this.$usedState = ["data", "loopArray75", "loopArray76", "loopArray77", "loopArray78", "IMGCDNURL", "checkpan", "checkone", "headerimg", "age", "sex", "project", "skillbooksone", "telephone"];
  ...
  _createClass(Preview, [{
    ...
    value: function _createData() {
      ...
      var _useState7 = (0, _taroSwan.useState)('未填写'),
      ...
      var _useState11 = (0, _taroSwan.useState)('未填写'),
      ...
      var loopArray75 = data.info.miniInfoOccupations.length ? data.info.miniInfoOccupations.map(function (v, i) {
        v = {
      ...
      var loopArray76 = data.introduces.tags.length ? data.introduces.tags.map(function (v, i) {
        v = {
          privateOriginal: (0, _taroSwan.internal_get_original)(v)
        };
      ...
      var loopArray77 = data.project.length ? project.map(function (item, i) {
        item = {
          privateOriginal: (0, _taroSwan.internal_get_original)(item)
        };
        var loopState__temp6 = data.project.length ? i + i : null;
        var anonymousCallee__14 = data.project.length ? item.privateOriginal.image.map(function (v, i) {
          v = {
            privateOriginal: (0, _taroSwan.internal_get_original)(v)
          };
          var loopState__temp8 = data.project.length ? i + i : null;
          var _$indexKey = "hizzz" + i + "-" + i;
      ...
      var loopArray78 = data.certificates.length ? skillbooksone.map(function (item, __index3) {
        item = {
          privateOriginal: (0, _taroSwan.internal_get_original)(item)
        };
        var anonymousCallee__15 = data.certificates.length ? item.privateOriginal.image.map(function (v, i) {
          v = {
            privateOriginal: (0, _taroSwan.internal_get_original)(v)
          };
          var loopState__temp10 = data.certificates.length ? i + i : null;
          var _$indexKey2 = "hjzzz" + __index3 + "-" + i;
