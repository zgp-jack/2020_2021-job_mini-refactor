...
var Preview = (_temp2 = _class = function (_Taro$Component) {
  ...
  function Preview() {
    ...
    }, _this.$usedState = ["data", "loopArray131", "loopArray132", "loopArray133", "loopArray134", "IMGCDNURL", "checkpan", "checkone", "headerimg", "age", "sex", "project", "skillbooksone", "telephone"], _this.anonymousFunc0Map = {}, _this.anonymousFunc2Map = {}, _this.customComponents = [], _temp), _possibleConstructorReturn(_this, _ret);
  }
  ...
  _createClass(Preview, [{
    ...
    value: function _createData() {
      ...
      var loopArray131 = data.info.miniInfoOccupations.length ? data.info.miniInfoOccupations.map(function (v, i) {
        v = {
      ...
      var loopArray132 = data.introduces.tags.length ? data.introduces.tags.map(function (v, i) {
        v = {
          $original: (0, _taroWeapp.internal_get_original)(v)
        };
      ...
      var loopArray133 = data.project.length ? project.map(function (item, i) {
        item = {
      ...
      var loopArray134 = data.certificates.length ? skillbooksone.map(function (item, __index3) {
        item = {
          $original: (0, _taroWeapp.internal_get_original)(item)
        };
        var $anonymousCallee__28 = data.certificates.length ? item.$original.image.map(function (v, i) {
          ...
          var _$indexKey2 = "bedzz" + __index3 + "-" + i;
