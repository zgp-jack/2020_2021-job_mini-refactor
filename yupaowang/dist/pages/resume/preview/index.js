...
var Preview = (_temp2 = _class = function (_Taro$Component) {
  ...
  function Preview() {
    ...
    }, _this.$usedState = ["data", "loopArray125", "loopArray126", "loopArray127", "loopArray128", "IMGCDNURL", "checkpan", "checkone", "headerimg", "age", "sex", "project", "skillbooksone", "telephone"], _this.customComponents = [], _temp), _possibleConstructorReturn(_this, _ret);
  }
  ...
  _createClass(Preview, [{
    ...
    value: function _createData() {
      ...
      var loopArray125 = data.info.miniInfoOccupations.length ? data.info.miniInfoOccupations.map(function (v, i) {
        v = {
      ...
      var loopArray126 = data.introduces.tags.length ? data.introduces.tags.map(function (v, i) {
        v = {
          $original: (0, _taroWeapp.internal_get_original)(v)
        };
      ...
      var loopArray127 = data.project.length ? project.map(function (item, i) {
        item = {
      ...
      var loopArray128 = data.certificates.length ? skillbooksone.map(function (item, _anonIdx) {
        item = {
          $original: (0, _taroWeapp.internal_get_original)(item)
        };
