...
var Preview = function (_Taro$Component) {
  ...
  function Preview() {
    ...
    _this.$usedState = ["data", "loopArray93", "loopArray94", "loopArray95", "loopArray96", "IMGCDNURL", "checkpan", "checkone", "headerimg", "age", "sex", "project", "skillbooksone", "telephone"];
  ...
  _createClass(Preview, [{
    ...
    value: function _createData() {
      ...
      var loopArray93 = data.info.miniInfoOccupations.length ? data.info.miniInfoOccupations.map(function (v, i) {
        v = {
      ...
      var loopArray94 = data.introduces.tags.length ? data.introduces.tags.map(function (v, i) {
        v = {
          $original: (0, _taroTt.internal_get_original)(v)
        };
      ...
      var loopArray95 = data.project.length ? project.map(function (item, i) {
        item = {
      ...
      var loopArray96 = data.certificates.length ? skillbooksone.map(function (item, __index3) {
        item = {
          $original: (0, _taroTt.internal_get_original)(item)
        };
