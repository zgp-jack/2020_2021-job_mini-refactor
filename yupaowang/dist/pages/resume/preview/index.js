...
var Preview = function (_Taro$Component) {
  ...
  function Preview() {
    ...
    _this.$usedState = ["data", "loopArray100", "loopArray101", "loopArray102", "loopArray103", "IMGCDNURL", "checkpan", "checkone", "headerimg", "age", "sex", "project", "skillbooksone", "ISCANSHARE", "telephone"];
