(swan["webpackJsonp"] = swan["webpackJsonp"] || []).push([["pages/resume/recList/index"],{
...
var RecListPage = function (_Taro$Component) {
  ...
  function RecListPage() {
    ...
    _this.$usedState = ["data", "loopArray74", "IMGCDNURL", "isDown"];
  ...
  _createClass(RecListPage, [{
    ...
    value: function _createData() {
      ...
      ;
      // 获取缓存数据
      var IntroinfoList = _taroSwan2.default.getStorageSync(_store.Introinfo);
      // 获取数据
      ...
      this.anonymousFunc2 = function () {
        return _taroSwan2.default.reLaunch({ url: '/pages/index/index?type=' + _tabbar.RESUME });
      };
      var loopArray74 = data.item.map(function (v, __index1) {
        v = {
          privateOriginal: (0, _taroSwan.internal_get_original)(v)
        };
        var _$indexKey = "hhzzz" + __index1;
        _this2.anonymousFunc1Map[_$indexKey] = function () {
          return userRouteJump("/pages/detail/info/index?id=" + v.privateOriginal.id);
        };
        return {
...
Page(__webpack_require__(/*! @tarojs/taro-swan */ "./node_modules/@tarojs/taro-swan/index.js").default.createComponent(RecListPage, true));
