...
var PersonInfo = function (_Taro$Component) {
  ...
  function PersonInfo() {
    ...
    _this.$usedState = ["loopArray96", "formData", "multiIndex", "multiArray", "proficiencyIndex", "proficiency", "userIndex", "personnel", "ranks", "label"];
  ...
  _createClass(PersonInfo, [{
    ...
    value: function _createData() {
      ...
      var loopArray96 = label.map(function (v, __index6) {
        v = {
          $original: (0, _taroWeapp.internal_get_original)(v)
        };
        var _$indexKey = "badzz" + __index6;
