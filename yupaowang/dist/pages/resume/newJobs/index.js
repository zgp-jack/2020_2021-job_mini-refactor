(swan["webpackJsonp"] = swan["webpackJsonp"] || []).push([["pages/resume/newJobs/index"],{
...
var context = exports.context = (0, _taroSwan.createContext)({});
...
var NewJob = function (_Taro$Component) {
  ...
  function NewJob() {
    ...
    _this.$usedState = ["anonymousState__temp", "data", "loopArray68", "loopArray69", "loopArray70", "loopArray71", "loopArray72", "loopArray73", "$compid__64", "$compid__65", "$compid__66", "showtop", "showcomplete", "IMGCDNURL", "showtopone", "showpassre", "passre", "nopassre", "index", "checkone", "headerimg", "authenticationimg", "certificate_show", "age", "sex", "checkonef", "showskill", "intro", "introne", "ressonone", "selfintrone", "checktwo", "selfintro", "projectlength", "project_count", "project", "skilllength", "skillbooksone", "checkfourf", "recData", "selectdata", "proStatus", "popup"];
  ...
  _createClass(NewJob, [{
    ...
    value: function _createData() {
      ...
      var _genCompid5 = (0, _taroSwan.genCompid)(__prefix + "$compid__66"),
      ...
      var _useState25 = (0, _taroSwan.useState)(0),
      ...
      var _useState27 = (0, _taroSwan.useState)('未填写'),
      ...
      var _useState33 = (0, _taroSwan.useState)(true),
      ...
      var _useState35 = (0, _taroSwan.useState)(true),
      ...
      var _useState37 = (0, _taroSwan.useState)(false),
      ...
      var _useState39 = (0, _taroSwan.useState)(true),
      ...
      var _useState41 = (0, _taroSwan.useState)(false),
      ...
      var _useState43 = (0, _taroSwan.useState)(false),
      ...
      var _useState45 = (0, _taroSwan.useState)(false),
      ...
      var _useState47 = (0, _taroSwan.useState)(0),
      ...
      var _useState49 = (0, _taroSwan.useState)(0),
      ...
      var _useState51 = (0, _taroSwan.useState)([]),
      ...
      var _useState53 = (0, _taroSwan.useState)(0),
      ...
      var _useState55 = (0, _taroSwan.useState)('0'),
      ...
      var _useState59 = (0, _taroSwan.useState)([]),
      ...
      var _useState61 = (0, _taroSwan.useState)(_area.AREABEIJING.name),
      ...
      var _useState63 = (0, _taroSwan.useState)(),
      ...
      var _useState65 = (0, _taroSwan.useState)(),
      ...
      var _useState67 = (0, _taroSwan.useState)('0'),
      ...
      var _useState69 = (0, _taroSwan.useState)(''),
      ...
      var _useState71 = (0, _taroSwan.useState)(false),
      ...
      var _useState73 = (0, _taroSwan.useState)(false),
      ...
      var _useState75 = (0, _taroSwan.useState)(0),
          _useState76 = _slicedToArray(_useState75, 2),
          indextop = _useState76[0],
          setIndextop = _useState76[1];

      var _useState77 = (0, _taroSwan.useState)(0),
      ...
      var getDataList = function getDataList() {
        (0, _index.resumeListAction)().then(function (res) {
          if (res.errcode == 200) {
            ...
            _taroSwan2.default.setStorageSync("introinfo", res.data.info);
            ...
            // 获取存储时间
            var toppingTime = _taroSwan2.default.getStorageSync('toptimer');
            ...
            if (!toppingTime && !top_onoff && res.data.info.uuid && onoff && res.data.info.check !== '1' && index === 0) {
              ...
              _taroSwan2.default.setStorageSync("toptimer", newTime);
            }
            {
      ...
      var loopArray68 = data.resume_top.has_top != 0 && data.resume_top.is_top != 2 ? data.resume_top.top_provinces_str.map(function (v, i) {
        v = {
      ...
      var loopArray69 = !showskill ? data.info.occupations.map(function (v, i) {
        v = {
          privateOriginal: (0, _taroSwan.internal_get_original)(v)
        };
      ...
      var loopArray70 = showskill ? data.info.occupations.map(function (v, i) {
        v = {
          privateOriginal: (0, _taroSwan.internal_get_original)(v)
        };
      ...
      var loopArray71 = selfintrone ? data.introduces.tags.map(function (v, i) {
        v = {
          privateOriginal: (0, _taroSwan.internal_get_original)(v)
        };
      ...
      var loopArray72 = projectlength != 0 ? project.map(function (item, __index16) {
        item = {
          privateOriginal: (0, _taroSwan.internal_get_original)(item)
        };
        var _$indexKey = "hdzzz" + __index16;
        _this2.anonymousFunc16Map[_$indexKey] = function () {
          return userRouteJump("/pages/resume/addProject/index?type=0&id=" + data.info.uuid);
        };
        var _$indexKey2 = "hezzz" + __index16;
        _this2.anonymousFunc17Map[_$indexKey2] = function () {
          return userRouteJump("/pages/resume/addProject/index?type=0&id=" + data.info.uuid);
        };
        var anonymousCallee__12 = projectlength != 0 ? item.privateOriginal.image.map(function (v, i) {
          v = {
            privateOriginal: (0, _taroSwan.internal_get_original)(v)
          };
          var loopState__temp11 = item.privateOriginal.image ? i + i : null;
          return {
      ...
      var loopArray73 = skilllength != 0 ? skillbooksone.map(function (item, i) {
        item = {
          privateOriginal: (0, _taroSwan.internal_get_original)(item)
        };
        var loopState__temp13 = skillbooksone ? i + i : null;
        var _$indexKey3 = "hfzzz" + i;
        _this2.anonymousFunc21Map[_$indexKey3] = function () {
          return userRouteJump("/pages/resume/addSkill/index?type=" + i + "&id=" + data.info.uuid);
        };
        var _$indexKey4 = "hgzzz" + i;
        _this2.anonymousFunc22Map[_$indexKey4] = function () {
          return userRouteJump("/pages/resume/addSkill/index?type=" + i + "&id=" + data.info.uuid);
        };
        var anonymousCallee__13 = skilllength != 0 ? item.privateOriginal.image.map(function (v, i) {
          v = {
            privateOriginal: (0, _taroSwan.internal_get_original)(v)
          };
          var loopState__temp15 = item.privateOriginal.image ? i + i : null;
          return {
      ...
      recData.length && _taroSwan.propsManager.set({
        "type": 1,
        "data": recData
...
Page(__webpack_require__(/*! @tarojs/taro-swan */ "./node_modules/@tarojs/taro-swan/index.js").default.createComponent(NewJob, true));
