...
var ResumeDetail = function (_Taro$Component) {
  ...
  function ResumeDetail() {
    ...
    _this.$usedState = ["data", "loopArray84", "loopArray86", "loopArray87", "$compid__72", "$compid__73", "isAuth", "IMGCDNURL", "examine", "onoff", "list", "praise", "collect", "shownewtips", "complaintModal", "age", "phone"];
  ...
  _createClass(ResumeDetail, [{
    ...
    value: function _createData() {
      ...
      var loopArray84 = data.info.occupations.length ? data.info.occupations.map(function (v, i) {
        v = {
      ...
      var loopArray86 = data.project.length ? data.project[0].image.map(function (v, i) {
        v = {
          $original: (0, _taroWeapp.internal_get_original)(v)
        };
      ...
      var loopArray87 = data.certificates.length ? data.certificates[0].image.map(function (val, i) {
        val = {
