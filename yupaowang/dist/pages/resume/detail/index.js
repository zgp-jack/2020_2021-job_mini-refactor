...
var ResumeDetail = function (_Taro$Component) {
  ...
  function ResumeDetail() {
    ...
    _this.$usedState = ["anonymousState__temp", "anonymousState__temp4", "anonymousState__temp5", "data", "loopArray89", "loopArray91", "loopArray92", "$compid__80", "$compid__81", "isAuth", "IMGCDNURL", "examine", "onoff", "SERIES", "QQSERIES", "ios", "login", "user", "praise", "ISCANSHARE", "collect", "shownewtips", "recommendRe", "complaintModal", "BAIDUSERIES", "age", "phone"];
