(qq["webpackJsonp"] = qq["webpackJsonp"] || []).push([["pages/resume/detail/index"],{
...
var ResumeDetail = function (_Taro$Component) {
  ...
  _createClass(ResumeDetail, [{
    ...
    value: function _createData() {
      ...
      var _genCompid = (0, _taroQq.genCompid)(__prefix + "$compid__80"),
          _genCompid2 = _slicedToArray(_genCompid, 2),
          $prevCompid__80 = _genCompid2[0],
          $compid__80 = _genCompid2[1];

      var _genCompid3 = (0, _taroQq.genCompid)(__prefix + "$compid__81"),
      ...
      var _useState7 = (0, _taroQq.useState)(true),
          _useState8 = _slicedToArray(_useState7, 2),
          examine = _useState8[0],
          setExamine = _useState8[1];
      // 是否查看过电话
      ...
      var _useState17 = (0, _taroQq.useState)(0),
          ...
          praise = _useState18[0],
          setPraise = _useState18[1];
      // 年龄
      ...
      var _useState21 = (0, _taroQq.useState)(false),
          ...
          complaintModal = _useState22[0],
          setComplaintModal = _useState22[1];
      // 投诉内容
      ...
      var _useState25 = (0, _taroQq.useState)(false),
      ...
      var _useState27 = (0, _taroQq.useState)(false),
          ...
          isAuth = _useState28[0],
          setIsAuth = _useState28[1];

      var _useState29 = (0, _taroQq.useState)(''),
          _useState30 = _slicedToArray(_useState29, 2),
          clickType = _useState30[0],
          setClickType = _useState30[1];
      // 更多招工省市
      ...
      var handleMap = function handleMap() {
        _taroQq2.default.getSetting().then(function (res) {
      ...
      var seeMoreResume = function seeMoreResume() {
        ...
        if (pages.length < 2) {
          _taroQq2.default.reLaunch({ url: _index2.INDEXPATH + "?type=resume" });
        } else {
          _taroQq2.default.navigateBack();
        }
      };
      ...
      this.anonymousFunc1 = function () {
        return _taroQq2.default.makePhoneCall({ phoneNumber: phone });
      };
      ...
      this.anonymousFunc5 = function () {
        return _taroQq2.default.navigateTo({ url: '/subpackage/pages/projects/index' });
      };
      this.anonymousFunc7 = function () {
        return _taroQq2.default.navigateTo({ url: '/subpackage/pages/skills/index' });
      };
      ...
      var loopArray92 = data.certificates.length ? data.certificates[0].image.map(function (val, i) {
        val = {
          $original: (0, _taroQq.internal_get_original)(val)
        };
      ...
      recommendRe.length && _taroQq.propsManager.set({
        "data": recommendRe,
        "type": 2,
        "areasId": areasId,
...
Component(__webpack_require__(/*! @tarojs/taro-qq */ "./node_modules/@tarojs/taro-qq/index.js").default.createComponent(ResumeDetail, true));
