...
var ResumeDetail = function (_Taro$Component) {
  ...
  function ResumeDetail() {
    ...
    _this.$usedState = ["data", "loopArray92", "loopArray94", "loopArray95", "$compid__76", "isAuth", "IMGCDNURL", "examine", "onoff", "praise", "ISCANSHARE", "collect", "shownewtips", "complaintModal", "age", "phone"];
