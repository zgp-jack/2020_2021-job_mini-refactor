...
var ResumeDetail = (_temp2 = _class = function (_Taro$Component) {
  ...
  function ResumeDetail() {
    ...
    }, _this.$usedState = ["data", "loopArray140", "loopArray142", "loopArray143", "$compid__119", "IMGCDNURL", "examine", "onoff", "praise", "collect", "shownewtips", "complaintModal", "textarea", "phone"], _this.customComponents = ["CollectionRecruitList"], _temp), _possibleConstructorReturn(_this, _ret);
  }
  ...
  _createClass(ResumeDetail, [{
    ...
    value: function _createData() {
      ...
      var loopArray140 = data.info.occupations.length ? data.info.occupations.map(function (v, i) {
        v = {
      ...
      var loopArray142 = data.project.length ? data.project[0].image.map(function (v, i) {
        v = {
          $original: (0, _taroWeapp.internal_get_original)(v)
        };
      ...
      var loopArray143 = data.certificates.length ? data.certificates[0].image.map(function (val, i) {
        val = {
