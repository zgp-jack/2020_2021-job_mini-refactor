...
<<<<<<< HEAD
    _this.$usedState = ["data", "loopArray92", "loopArray94", "loopArray95", "$compid__76", "isAuth", "IMGCDNURL", "examine", "onoff", "praise", "collect", "shownewtips", "complaintModal", "age", "phone"];
=======
    _this.$usedState = ["data", "loopArray111", "loopArray113", "loopArray114", "$compid__84", "isAuth", "IMGCDNURL", "examine", "onoff", "praise", "ISCANSHARE", "collect", "shownewtips", "complaintModal", "age", "phone"];
>>>>>>> f21abad4253bc223f8aa7507778bd4dd150dce4e
...
=======
      var loopArray111 = data.info.occupations.length ? data.info.occupations.map(function (v, i) {
>>>>>>> f21abad4253bc223f8aa7507778bd4dd150dce4e
        v = {
...
=======
      var loopArray113 = data.project.length ? data.project[0].image.map(function (v, i) {
>>>>>>> f21abad4253bc223f8aa7507778bd4dd150dce4e
        v = {
          $original: (0, _taroTt.internal_get_original)(v)
        };
...
=======
      var loopArray114 = data.certificates.length ? data.certificates[0].image.map(function (val, i) {
>>>>>>> f21abad4253bc223f8aa7507778bd4dd150dce4e
        val = {
