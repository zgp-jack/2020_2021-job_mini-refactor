...
var BasicsPage = function (_Taro$Component) {
  ...
  function BasicsPage() {
    ...
    _this.$usedState = ["anonymousState__temp", "$compid__79", "$compid__80", "showProfession", "formData", "sexList", "nationCurrent", "isCode", "text"];
  ...
  _createClass(BasicsPage, [{
    ...
    value: function _createData() {
      ...
      var handleSubmit = function handleSubmit() {
        ...
        if (!nation) {
          (0, _index3.default)('请选择民族');
          return;
        }
        if (!clickOccupation) {
          (0, _index3.default)('请选择您的工种');
          return;
        }
        if (!formData.are) {
        ...
        (0, _index.addResumeAction)(params).then(function (res) {
          if (res.errcode == '200') {
            ...
            (0, _index2.showModalTip)({ tips: res.errmsg });
          }
        });
      };
