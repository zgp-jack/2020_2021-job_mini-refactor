...
var BasicsPage = function (_Taro$Component) {
  ...
  function BasicsPage() {
    ...
    _this.$usedState = ["anonymousState__temp", "$compid__67", "$compid__68", "showProfession", "formData", "sexList", "nationCurrent", "isCode", "text"];
  ...
  _createClass(BasicsPage, [{
    ...
    value: function _createData() {
      ...
      var _genCompid3 = (0, _taroTt.genCompid)(__prefix + "$compid__68"),
