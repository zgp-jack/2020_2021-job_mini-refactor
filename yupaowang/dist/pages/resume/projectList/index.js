...
var ProjectList = (_temp2 = _class = function (_Taro$Component) {
  ...
  function ProjectList() {
    ...
    }, _this.$usedState = ["loopArray85", "data", "IMGCDNURL"], _this.customComponents = [], _temp), _possibleConstructorReturn(_this, _ret);
  }
  ...
  _createClass(ProjectList, [{
    ...
    value: function _createData() {
      ...
      var loopArray85 = data.map(function (item, _anonIdx) {
        item = {
          $original: (0, _taroWeapp.internal_get_original)(item)
        };
        var $anonymousCallee__16 = item.$original.image.map(function (v, i) {
          v = {
  ...
  return ProjectList;
}(_taroWeapp2.default.Component), _class.$$events = [], _class.$$componentPath = "pages/resume/projectList/index", _temp2);
