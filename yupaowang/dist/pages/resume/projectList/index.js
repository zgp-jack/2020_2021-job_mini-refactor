...
var ProjectList = (_temp2 = _class = function (_Taro$Component) {
  ...
  function ProjectList() {
    ...
    }, _this.$usedState = ["loopArray92", "data", "IMGCDNURL"], _this.anonymousFunc0Map = {}, _this.anonymousFunc1Map = {}, _this.customComponents = [], _temp), _possibleConstructorReturn(_this, _ret);
  }
  ...
  _createClass(ProjectList, [{
    ...
    value: function _createData() {
      ...
      var loopArray92 = data.map(function (item, i) {
        item = {
