...
var AtDrawer = (_temp2 = _class = function (_AtComponent) {
  ...
  _createClass(AtDrawer, [{
    ...
    value: function _createData() {
      ...
      var loopArray8 = items.length ? items.map(function (name, index) {
        name = {
          $original: (0, _taroWeapp.internal_get_original)(name)
        };
        var $loopState__temp5 = _show ? items.length ? name.$original + "-" + index : null : null;

        var _genCompid = (0, _taroWeapp.genCompid)(__prefix + 'ezzzzzzzzz' + index, true),
...
},[["./node_modules/taro-ui/dist/weapp/components/drawer/index.js","runtime","taro","vendors"]]]);