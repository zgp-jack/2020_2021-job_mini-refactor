(qq["webpackJsonp"] = qq["webpackJsonp"] || []).push([["npm/taro-ui/dist/weapp/components/drawer/index"],{
...
var AtDrawer = (_temp2 = _class = function (_AtComponent) {
  ...
  _createClass(AtDrawer, [{
    ...
    value: function _createData() {
      ...
      var anonymousState__temp2 = _show ? (0, _taroQq.internal_inline_style)(maskStyle) : null;
      var anonymousState__temp3 = _show ? (0, _taroQq.internal_inline_style)(listStyle) : null;
      var loopArray26 = items.length ? items.map(function (name, index) {
        name = {
          $original: (0, _taroQq.internal_get_original)(name)
        };
        var $loopState__temp5 = _show ? items.length ? name.$original + "-" + index : null : null;

        var _genCompid = (0, _taroQq.genCompid)(__prefix + 'dazzzzzzzz' + index, true),
            _genCompid2 = _slicedToArray(_genCompid, 2),
            $prevCompid__28 = _genCompid2[0],
            $compid__28 = _genCompid2[1];

        _show && items.length && _taroQq.propsManager.set({
...
Component(__webpack_require__(/*! @tarojs/taro-qq */ "./node_modules/@tarojs/taro-qq/index.js").default.createComponent(AtDrawer));
