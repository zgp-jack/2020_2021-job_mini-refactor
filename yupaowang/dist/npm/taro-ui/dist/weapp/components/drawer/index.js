...
var AtDrawer = (_temp2 = _class = function (_AtComponent) {
  ...
  _createClass(AtDrawer, [{
    ...
    value: function _createData() {
      ...
      var loopArray28 = items.length ? items.map(function (name, index) {
        ...
        var _genCompid = (0, _taroSwan.genCompid)(__prefix + 'dfzzzzzzzz' + index, true),
  ...
  return AtDrawer;
}(_component2.default), _class.$$events = ["onMaskClick"], _class.$$componentPath = "C:/Users/123/Desktop/yupao-ts-recode/yupaowang/node_modules/taro-ui/dist/weapp/components/drawer/index", _temp2);
