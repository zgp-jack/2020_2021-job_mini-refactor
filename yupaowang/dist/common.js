...
var NewJob = (_temp2 = _class = function (_Taro$Component) {
  ...
  function NewJob() {
    ...
    }, _this.$usedState = ["anonymousState__temp", "data", "loopArray146", "loopArray147", "loopArray148", "loopArray149", "loopArray150", "loopArray151", "$compid__121", "$compid__122", "$compid__123", "showtop", "showcomplete", "IMGCDNURL", "showtopone", "showpassre", "passre", "nopassre", "index", "checkstatus", "checkone", "headerimg", "authenticationimg", "certificate_show", "age", "sex", "checkonef", "showskill", "intro", "introne", "ressonone", "selfintrone", "checktwo", "selfintro", "projectlength", "project_count", "project", "proStatus", "skilllength", "skillbooksone", "checkfourf", "isOpened", "selectdata", "popup"], _this.anonymousFunc6Map = {}, _this.anonymousFunc9Map = {}, _this.anonymousFunc10Map = {}, _this.customComponents = ["CollectionRecruitList", "AtModal"], _temp), _possibleConstructorReturn(_this, _ret);
  }
  ...
  _createClass(NewJob, [{
    ...
    value: function _createData() {
      ...
      this.anonymousFunc2 = handleStatus;
      ...
      var loopArray146 = data.resume_top.has_top != 0 && data.resume_top.is_top != 2 ? data.resume_top.top_provinces_str.map(function (v, i) {
        v = {
      ...
      var loopArray147 = !showskill ? data.info.occupations.map(function (v, i) {
        v = {
          $original: (0, _taroWeapp.internal_get_original)(v)
        };
      ...
      var loopArray148 = showskill ? data.info.occupations.map(function (v, i) {
        v = {
          $original: (0, _taroWeapp.internal_get_original)(v)
        };
      ...
      var loopArray149 = selfintrone ? data.introduces.tags.map(function (v, i) {
        v = {
          $original: (0, _taroWeapp.internal_get_original)(v)
        };
      ...
      var loopArray150 = projectlength != 0 ? project.map(function (item, __index6) {
        item = {
          $original: (0, _taroWeapp.internal_get_original)(item)
        };

        var _$indexKey = "bdfzz" + __index6;
      ...
      var loopArray151 = skilllength != 0 ? skillbooksone.map(function (item, i) {
        item = {
          $original: (0, _taroWeapp.internal_get_original)(item)
        };
        var $loopState__temp13 = skillbooksone ? i + i : null;

        var _$indexKey2 = "bdgzz" + i;

        _this2.anonymousFunc9Map[_$indexKey2] = function () {
          return userRouteJump("/subpackage/pages/addSkill/index?type=" + i);
        };

        var _$indexKey3 = "bdhzz" + i;

        _this2.anonymousFunc10Map[_$indexKey3] = function () {
          return userRouteJump("/subpackage/pages/addSkill/index?type=" + i);
        };
    ...
    key: "anonymousFunc9",
    value: function anonymousFunc9(_$indexKey2) {
      ...
      return this.anonymousFunc9Map[_$indexKey2] && (_anonymousFunc9Map = this.anonymousFunc9Map)[_$indexKey2].apply(_anonymousFunc9Map, e);
    }
  }, {
    key: "anonymousFunc10",
    value: function anonymousFunc10(_$indexKey3) {
      ...
      return this.anonymousFunc10Map[_$indexKey3] && (_anonymousFunc10Map = this.anonymousFunc10Map)[_$indexKey3].apply(_anonymousFunc10Map, e);
    }
  }, {
    key: "anonymousFunc11",
...
var Topping = (_temp2 = _class = function (_Taro$Component) {
  ...
  function Topping() {
    ...
    }, _this.$usedState = ["params", "data", "loopArray130", "loopArray131", "loopArray132", "loopArray133", "IMGCDNURL", "type", "list", "displayTime", "num", "endTime", "editData", "newTime", "day", "SERVERPHONE"], _this.anonymousFunc0Map = {}, _this.anonymousFunc1Map = {}, _this.anonymousFunc2Map = {}, _this.customComponents = [], _temp), _possibleConstructorReturn(_this, _ret);
  }
  ...
  _createClass(Topping, [{
    ...
    value: function _createData() {
      ...
      var _useState21 = (0, _taroWeapp.useState)(false),
          _useState22 = _slicedToArray(_useState21, 2),
          displayTime = _useState22[0],
          setdisplayTime = _useState22[1];
      // 最新时间


      var _useState23 = (0, _taroWeapp.useState)(''),
          _useState24 = _slicedToArray(_useState23, 2),
          newTime = _useState24[0],
          setNewTime = _useState24[1];
      // 修改时最大积分
      ...
      context.Provider(value);
      this.anonymousFunc3 = handleAddJump;

      this.anonymousFunc4 = function () {
        return userRouteJump("/pages/topping/distruction/index?max_city=" + city.max_city + "&max_province=" + city.max_province);
      };
      ...
      this.anonymousFunc6 = handleCancel;

      this.anonymousFunc7 = function (e) {
        return handleClick(e);
      };

      this.anonymousFunc8 = handleTopping;

      this.anonymousFunc9 = function () {
        _taroWeapp2.default.makePhoneCall({ phoneNumber: _index2.SERVERPHONE });
      };

      var loopArray130 = params ? params.city.map(function (v, __index0) {
        v = {
          $original: (0, _taroWeapp.internal_get_original)(v)
        };

        var _$indexKey = "bcgzz" + __index0;
      ...
      var loopArray131 = params ? params.province.map(function (v, __index1) {
        v = {
          $original: (0, _taroWeapp.internal_get_original)(v)
        };

        var _$indexKey2 = "bchzz" + __index1;
      ...
      var loopArray132 = params ? params.whole.map(function (v, __index2) {
        v = {
          $original: (0, _taroWeapp.internal_get_original)(v)
        };

        var _$indexKey3 = "bcizz" + __index2;
      ...
      var loopArray133 = data.top_rules.map(function (v, i) {
        v = {
          $original: (0, _taroWeapp.internal_get_original)(v)
        };
  ...
  return Topping;
}(_taroWeapp2.default.Component), _class.$$events = ["anonymousFunc0", "anonymousFunc1", "anonymousFunc2", "anonymousFunc3", "anonymousFunc4", "anonymousFunc5", "anonymousFunc6", "anonymousFunc7", "anonymousFunc8", "anonymousFunc9"], _class.$$componentPath = "pages/topping/index", _temp2);
