...
var PublishRecruit = (_temp2 = _class = function (_Taro$Component) {
  ...
  function PublishRecruit() {
    ...
    }, _this.$usedState = ["model", "$compid__103", "$compid__104", "$compid__105", "showProfession", "phone", "showUpload", "text"], _this.customComponents = ["Auth", "Profession", "WordsTotal", "ImageView"], _temp), _possibleConstructorReturn(_this, _ret);
  }
...
var Topping = (_temp2 = _class = function (_Taro$Component) {
  ...
  function Topping() {
    ...
    }, _this.$usedState = ["params", "data", "loopArray119", "loopArray120", "loopArray121", "loopArray122", "IMGCDNURL", "type", "list", "displayTime", "num", "endTime", "editData", "newTime", "day", "SERVERPHONE"], _this.anonymousFunc0Map = {}, _this.anonymousFunc1Map = {}, _this.anonymousFunc2Map = {}, _this.customComponents = [], _temp), _possibleConstructorReturn(_this, _ret);
  }
  ...
  _createClass(Topping, [{
    ...
    value: function _createData() {
      ...
      var loopArray119 = params ? params.city.map(function (v, __index0) {
        v = {
      ...
      var loopArray120 = params ? params.province.map(function (v, __index1) {
        v = {
          $original: (0, _taroWeapp.internal_get_original)(v)
        };

        var _$indexKey2 = "baczz" + __index1;
      ...
      var loopArray121 = params ? params.whole.map(function (v, __index2) {
        v = {
          $original: (0, _taroWeapp.internal_get_original)(v)
        };

        var _$indexKey3 = "badzz" + __index2;
      ...
      var loopArray122 = data.top_rules.map(function (v, i) {
        v = {
          $original: (0, _taroWeapp.internal_get_original)(v)
        };
