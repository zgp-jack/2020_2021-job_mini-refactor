...
var _App = function (_BaseComponent) {
  ...
  function _App() {
    ...
    _this.config = {
      ...
      'pages/resume/publish/index',
      //'pages/resume/add_info/index', //新增基本资料
      'pages/resume/add_member/index', 'pages/resume/add_skill/index', 'pages/resume/add_project/index', 'pages/resume/projects/index', 'pages/resume/skills/index', 'pages/rank-rules/index', 'pages/resume/detail/index', 'pages/resume/preview/index', 'pages/login/index'],
      subPackages: [{
