...
(qq["webpackJsonp"] = qq["webpackJsonp"] || []).push([["app"],{
...
App(__webpack_require__(/*! @tarojs/taro-qq */ "./node_modules/@tarojs/taro-qq/index.js").default.createApp(_App));
_taroQq2.default.initPxTransform({
  "designWidth": 750,
  "deviceRatio": {
    "640": 1.17,
    "750": 1,
...
function User() {
  ...
  switch (action.type) {
    ...
    case _user.GETUSER:
      if (!state.login) {
        var _userInfo = _taroQq2.default.getStorageSync(_store.UserInfo);
