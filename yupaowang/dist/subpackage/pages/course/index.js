  ...
  _createClass(Course, [{
    ...
    value: function _createData() {
      ...
      var loopArray116 = highlight === 1 ? bossData.item.map(function (item, __index1) {
        ...
        var _genCompid = (0, _taroWeapp.genCompid)(__prefix + "bbbzzzzzzz" + __index1, true),
        ...
        var _genCompid3 = (0, _taroWeapp.genCompid)(__prefix + "bbczzzzzzz" + __index1, true),
      ...
      var loopArray117 = highlight === 2 ? workerMaster.item.map(function (item, __index2) {
        ...
        var _genCompid5 = (0, _taroWeapp.genCompid)(__prefix + "bbdzzzzzzz" + __index2, true),
        ...
        var _genCompid7 = (0, _taroWeapp.genCompid)(__prefix + "bbezzzzzzz" + __index2, true),
