...
var Course = (_temp2 = _class = function (_Taro$Component) {
  ...
  function Course() {
    ...
    }, _this.$usedState = ["bossData", "workerMaster", "loopArray106", "loopArray107", "loopArray108", "tab", "highlight"], _this.anonymousFunc0Map = {}, _this.anonymousFunc1Map = {}, _this.anonymousFunc2Map = {}, _this.customComponents = ["Nodata", "AtAccordion", "AtList"], _temp), _possibleConstructorReturn(_this, _ret);
  }
  ...
  _createClass(Course, [{
    ...
    value: function _createData() {
      ...
      var loopArray106 = tab.map(function (item, __index0) {
        item = {
      ...
      var loopArray107 = highlight === 1 ? bossData.item.map(function (item, __index1) {
        item = {
          $original: (0, _taroWeapp.internal_get_original)(item)
        };
        ...
        var _genCompid = (0, _taroWeapp.genCompid)(__prefix + "iizzzzzzzz" + __index1, true),
        ...
        var _genCompid3 = (0, _taroWeapp.genCompid)(__prefix + "ijzzzzzzzz" + __index1, true),
      ...
      var loopArray108 = highlight === 2 ? workerMaster.item.map(function (item, __index2) {
        item = {
          $original: (0, _taroWeapp.internal_get_original)(item)
        };
        ...
        var _genCompid5 = (0, _taroWeapp.genCompid)(__prefix + "jazzzzzzzz" + __index2, true),
        ...
        var _genCompid7 = (0, _taroWeapp.genCompid)(__prefix + "jbzzzzzzzz" + __index2, true),
