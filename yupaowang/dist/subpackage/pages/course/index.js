...
var Course = (_temp2 = _class = function (_Taro$Component) {
  ...
  function Course() {
    ...
    }, _this.$usedState = ["bossData", "workerMaster", "loopArray112", "loopArray113", "loopArray114", "tab", "highlight"], _this.anonymousFunc0Map = {}, _this.anonymousFunc1Map = {}, _this.anonymousFunc2Map = {}, _this.customComponents = ["Nodata", "AtAccordion", "AtList"], _temp), _possibleConstructorReturn(_this, _ret);
  }
  ...
  _createClass(Course, [{
    ...
    value: function _createData() {
      ...
      var loopArray112 = tab.map(function (item, __index0) {
        item = {
          $original: (0, _taroWeapp.internal_get_original)(item)
        };

        var _$indexKey = "bagzz" + __index0;
      ...
      var loopArray113 = highlight === 1 ? bossData.item.map(function (item, __index1) {
        item = {
          $original: (0, _taroWeapp.internal_get_original)(item)
        };

        var _$indexKey2 = "bahzz" + __index1;

        _this2.anonymousFunc1Map[_$indexKey2] = function () {
          bossIsShow(item.$original.id);
        };

        var _genCompid = (0, _taroWeapp.genCompid)(__prefix + "bajzzzzzzz" + __index1, true),
        ...
        var _genCompid3 = (0, _taroWeapp.genCompid)(__prefix + "bbazzzzzzz" + __index1, true),
      ...
      var loopArray114 = highlight === 2 ? workerMaster.item.map(function (item, __index2) {
        item = {
          $original: (0, _taroWeapp.internal_get_original)(item)
        };

        var _$indexKey3 = "baizz" + __index2;

        _this2.anonymousFunc2Map[_$indexKey3] = function () {
          workerMasterIsShow(item.$original.id);
        };

        var _genCompid5 = (0, _taroWeapp.genCompid)(__prefix + "bbbzzzzzzz" + __index2, true),
        ...
        var _genCompid7 = (0, _taroWeapp.genCompid)(__prefix + "bbczzzzzzz" + __index2, true),
