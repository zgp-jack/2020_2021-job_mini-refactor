...
function userCode(type) {
  var _useState = (0, _taroSwan.useState)(type === false ? false : !!type),
...
function usePublishViewInfo(InitParams) {
  ...
  var _useState7 = (0, _taroSwan.useState)(_area.AREABEIJING.name),
...
var ResumeMap = function (_Taro$Component) {
  ...
  function ResumeMap() {
    ...
    _this.$usedState = ["loopArray26", "loopArray27", "$compid__27", "smAreaText", "showHistory", "histroyList", "lists", "IMGCDNURL", "showCity", "area"];
  ...
  _createClass(ResumeMap, [{
    ...
    value: function _createData() {
      ...
      var _genCompid = (0, _taroSwan.genCompid)(__prefix + "$compid__27"),
      ...
      var loopArray26 = showHistory ? histroyList.map(function (item, index) {
        item = {
      ...
      var loopArray27 = lists.map(function (item, index) {
        item = {
          privateOriginal: (0, _taroSwan.internal_get_original)(item)
        };
        var loopState__temp4 = index + index;
        var _$indexKey2 = "chzzz" + index;
...
var PublishRecruit = function (_Taro$Component) {
  ...
  function PublishRecruit() {
    ...
    _this.$usedState = ["model", "$compid__20", "$compid__21", "$compid__22", "showProfession", "phone", "showUpload", "text"];
  ...
  _createClass(PublishRecruit, [{
    ...
    value: function _createData() {
      ...
      var _genCompid = (0, _taroSwan.genCompid)(__prefix + "$compid__20"),
          _genCompid2 = _slicedToArray(_genCompid, 2),
          $prevCompid__20 = _genCompid2[0],
          $compid__20 = _genCompid2[1];

      var _genCompid3 = (0, _taroSwan.genCompid)(__prefix + "$compid__21"),
          _genCompid4 = _slicedToArray(_genCompid3, 2),
          $prevCompid__21 = _genCompid4[0],
          $compid__21 = _genCompid4[1];

      var _genCompid5 = (0, _taroSwan.genCompid)(__prefix + "$compid__22"),
...
var Topping = function (_Taro$Component) {
  ...
  function Topping() {
    ...
    _this.$usedState = ["params", "data", "loopArray53", "loopArray54", "loopArray55", "loopArray56", "loopArray57", "province", "IMGCDNURL", "rec", "basics", "type", "list", "displayTime", "num", "endTime", "editData", "newTime", "day", "SERVERPHONE"];
  ...
  _createClass(Topping, [{
    ...
    value: function _createData() {
      ...
      var loopArray53 = province ? province.map(function (v, __index0) {
        v = {
      ...
      var loopArray54 = params ? params.city.map(function (v, __index1) {
        v = {
          privateOriginal: (0, _taroSwan.internal_get_original)(v)
        };
        var _$indexKey2 = "fizzz" + __index1;
      ...
      var loopArray55 = params ? params.province.map(function (v, __index2) {
        v = {
          privateOriginal: (0, _taroSwan.internal_get_original)(v)
        };
        var _$indexKey3 = "fjzzz" + __index2;
      ...
      var loopArray56 = params ? params.whole.map(function (v, __index3) {
        v = {
          privateOriginal: (0, _taroSwan.internal_get_original)(v)
        };
        var _$indexKey4 = "gazzz" + __index3;
      ...
      var loopArray57 = data.top_rules.map(function (v, i) {
        v = {
          privateOriginal: (0, _taroSwan.internal_get_original)(v)
        };
...
var PhoneContext = exports.PhoneContext = (0, _taroSwan.createContext)({});
...
var UserUpdateInfo = function (_Taro$Component) {
  ...
  _createClass(UserUpdateInfo, [{
    ...
    value: function _createData() {
      ...
      var _useState = (0, _taroSwan.useState)(avatar),
          _useState2 = _slicedToArray(_useState, 2),
      ...
      var _useState5 = (0, _taroSwan.useState)(username),
          _useState6 = _slicedToArray(_useState5, 2),
          name = _useState6[0],
      ...
      var _useState7 = (0, _taroSwan.useState)(username),
          _useState8 = _slicedToArray(_useState7, 2),
      ...
      var _useState9 = (0, _taroSwan.useState)(phone),
          _useState10 = _slicedToArray(_useState9, 2),
...
Page(__webpack_require__(/*! @tarojs/taro-swan */ "./node_modules/@tarojs/taro-swan/index.js").default.createComponent(UserUpdateInfo, true));
