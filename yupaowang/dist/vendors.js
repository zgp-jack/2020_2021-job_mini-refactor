...
exports.setPublishData = setPublishData;
exports.getPublishData = getPublishData;

var _publish = __webpack_require__(/*! ../constants/publish */ "./src/constants/publish.ts");

function setPublishData(data) {
  return {
    type: _publish.SETPUBLISHDATA,
    data: data
  };
}
function getPublishData() {
  return {
    type: _publish.GETPUBLISHDATA
  };
}
