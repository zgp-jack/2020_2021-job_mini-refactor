...
var AtComponent = (_temp = _class = function (_Component) {
  ...
  return AtComponent;
}(_taroQq.Component), _class.options = {
  addGlobalClass: true
...
var ENV = _taroQq2.default.getEnv();
function delay() {
  var delayTime = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : 500;

  return new Promise(function (resolve) {
    if ([_taroQq2.default.ENV_TYPE.WEB, _taroQq2.default.ENV_TYPE.SWAN].includes(ENV)) {
      setTimeout(function () {
        resolve();
      }, delayTime);
      return;
...
function delayQuerySelector(self, selectorStr) {
  ...
  var $scope = ENV === _taroQq2.default.ENV_TYPE.WEB ? self : self.$scope;
  var selector = _taroQq2.default.createSelectorQuery().in($scope);
  return new Promise(function (resolve) {
...
function delayGetScrollOffset(_ref) {
  ...
  return new Promise(function (resolve) {
    delay(delayTime).then(function () {
      _taroQq2.default.createSelectorQuery().selectViewport().scrollOffset().exec(function (res) {
        resolve(res);
      });
    });
  });
...
function delayGetClientRect(_ref2) {
  ...
  var $scope = ENV === _taroQq2.default.ENV_TYPE.WEB || ENV === _taroQq2.default.ENV_TYPE.SWAN ? self : self.$scope;
  var selector = _taroQq2.default.createSelectorQuery().in($scope);
  return new Promise(function (resolve) {
    delay(delayTime).then(function () {
      selector.select(selectorStr).boundingClientRect().exec(function (res) {
...
function getEventDetail(event) {
  var detail = void 0;
  switch (ENV) {
    case _taroQq2.default.ENV_TYPE.WEB:
      detail = {
        pageX: event.pageX,
        pageY: event.pageY,
      ...
      break;
    case _taroQq2.default.ENV_TYPE.WEAPP:
      detail = {
      ...
      break;
    case _taroQq2.default.ENV_TYPE.ALIPAY:
      detail = {
      ...
      break;
    case _taroQq2.default.ENV_TYPE.SWAN:
      detail = {
...
function handleTouchScroll(flag) {
  if (ENV !== _taroQq2.default.ENV_TYPE.WEB) {
    return;
  }
  if (flag) {
...
function pxTransform(size) {
  if (!size) return '';
  return _taroQq2.default.pxTransform(size);
}
exports.delay = delay;
...
function useCode(type) {
  ...
  var _useState3 = (0, _taroQq.useState)(title),
...
function useResume() {
  ...
  var _useState = (0, _taroQq.useState)(resumeData.info),
      _useState2 = _slicedToArray(_useState, 2),
  ...
  var _useState3 = (0, _taroQq.useState)(resumeData.introducesData),
      _useState4 = _slicedToArray(_useState3, 2),
  ...
  var _useState5 = (0, _taroQq.useState)(resumeData.projectData),
  ...
  var _useState7 = (0, _taroQq.useState)(resumeData.certificates),
  ...
  var _useState9 = (0, _taroQq.useState)(_data.RESUME_TOP_DATA),
  ...
  var _useState11 = (0, _taroQq.useState)(0),
  ...
  var _useState13 = (0, _taroQq.useState)(0),
  ...
  var _useState15 = (0, _taroQq.useState)(0),
  ...
  var _useState17 = (0, _taroQq.useState)(0),
  ...
  var _useState21 = (0, _taroQq.useState)(0),
  ...
  var _useState23 = (0, _taroQq.useState)(''),
  ...
  var _useState27 = (0, _taroQq.useState)(''),
  ...
  var _useState29 = (0, _taroQq.useState)(0),
  ...
  var handleSelectData = function handleSelectData() {
    if (check == '2') {
      ...
      _taroQq2.default.showActionSheet({
...
function useResumeAddInfo() {
  ...
  var _useState = (0, _taroQq.useState)(addInfoConfig),
      _useState2 = _slicedToArray(_useState, 2),
...
function userAuthLoction() {
  return new Promise(function (resolve, reject) {
    var loc = _taroQq2.default.getStorageSync(_store.UserLocationCity);
    if (loc) resolve(loc);
    ...
    GDMAP.getRegeo({
      success: function success(data) {
        ...
        _taroQq2.default.setStorageSync(_store.UserLocationCity, gpsLocation); //定位信息
        resolve(gpsLocation);
      },
      fail: function fail() {
        reject();
...
function userJumpPage(url) {
  _taroQq2.default.navigateTo({ url: url });
}
// 数字四舍五入并向下取2位小数
...
function setClipboardData(val) {
  ...
  _taroQq2.default.setClipboardData({
    data: val,
    success: function success() {
      _taroQq2.default.hideToast();
...
function SubscribeToNews(type, callback) {
  ...
  var userInfo = _taroQq2.default.getStorageSync(_store.UserInfo);
  if (_taroQq2.default.canIUse('requestSubscribeMessage') === true) {
    _taroQq2.default.requestSubscribeMessage({
...
function AppUploadImg(resolve, res) {
  ...
  var userInfo = _taroQq2.default.getStorageSync(_store.UserInfo);
  _taroQq2.default.showLoading({ title: '图片上传中' });
  _taroQq2.default.uploadFile({
    url: url,
