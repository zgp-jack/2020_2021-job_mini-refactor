...
import { getAllAreas, checkAdcodeAction } from "../../../utils/request/index";
...
export default class ResumeMap extends Taro.Component {
  config = {
  ...
  render() {
    ...
    const [publishArea, setPublishArea] = Taro.useState('');
    // 详细地址的输入框
    ...
    return <contextItem.Provider value={value}>
