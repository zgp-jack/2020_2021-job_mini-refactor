...
import { IMGCDNURL, ISCANSHARE, INDEXPATH } from "../../../config/index";
import Imglist from "../../../components/imglist/index";
import { getUserShareMessage } from "../../../utils/helper/index";
import './index.scss';
export default class NewPreview extends Taro.Component {
  config = {
  ...
  render() {
    ...
    Taro.useShareAppMessage(() => {
      let path = show_tips == '1' ? INDEXPATH : `/pages/resume/detail/index?uuid=${info.uuid}`;
      return {
        ...getUserShareMessage(),
        path: path
      };
    });
    return <View className="resume-container">
      ...
      <View className="resume-content">
        ...
        {projectData.length && <View className="content-project-experience">
          <View className="basic-imformation">
        ...
        {certificates.length && <View className="content-professional-skill">
          <View className="basic-imformation">
...
NewPreview.config = { navigationBarTitleText: '找活名片', enablePullDownRefresh: true, navigationBarBackgroundColor: '#0099ff', navigationBarTextStyle: 'white', backgroundTextStyle: "dark" };