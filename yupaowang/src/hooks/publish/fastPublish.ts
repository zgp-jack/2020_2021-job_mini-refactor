...
import { RecruitPublishInfo, UserLastPublishRecruitArea, FastPublishInit } from '../../pages/recruit/index.d'
import { publishRecruitInfo, fastPublisView } from '../../utils/request'
