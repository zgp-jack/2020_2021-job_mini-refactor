...
export default function UsedList({ data = [], bottom = true, isend }: Props){
  // 用户查看二手交易详情
  ...
  return (
    ...
    {
      data[0].length && isend && <View className='showMore'>没有更多内容了</View>
    }
    { !data[0].length && isend && <View className='lists-nodata'>
