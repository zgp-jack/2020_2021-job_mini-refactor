...
class _Button extends React.Component {
    ...
    render() {
        const { style, children, size, type, plain, disabled, loading, hoverStyle, hoverStartTime, hoverStayTime, } = this.props;
        ...
        return (React.createElement(TouchableWithoutFeedback, { delayPressIn: hoverStartTime, delayPressOut: hoverStayTime, onPress: this.onPress, onPressIn: this.onPressIn, onPressOut: this.onPressOut, ref: this.$touchable },
            React.createElement(View, { style: [
                ...
                typeof children === 'string' ? React.createElement(Text, { style: [
                        styles.btnText,
