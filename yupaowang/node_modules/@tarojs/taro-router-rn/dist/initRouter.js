...
const react_1 = __importDefault(require("react")); // eslint-disable-line
...
function getRootStack({ pageList, Taro, navigationOptions }) {
    ...
    return createStackNavigator(RouteConfigs, Object.assign({ headerLayoutPreset: 'center' }, navigatorOptions));
}
