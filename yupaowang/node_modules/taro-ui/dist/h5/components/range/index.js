  ...
  render() {
    ...
    return <View className={rootCls} style={customStyle} onClick={this.handleClick}>
        <View className="at-range__container" style={containerStyle}>
          ...
          <View className="at-range__slider" style={this.mergeStyle(sliderAStyle, sliderStyle)} onTouchMove={this.handleTouchMove.bind(this, 'aX')} onTouchEnd={this.handleTouchEnd.bind(this, 'aX')}></View>
          <View className="at-range__slider" style={this.mergeStyle(sliderBStyle, sliderStyle)} onTouchMove={this.handleTouchMove.bind(this, 'bX')} onTouchEnd={this.handleTouchEnd.bind(this, 'bX')}></View>
        </View>
      </View>;
  }
  handleClick = event => {
