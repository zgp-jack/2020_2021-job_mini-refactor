...
class AtInputNumber extends AtComponent {
  ...
  render() {
    ...
    return <View className={rootCls} style={customStyle}>
        ...
        <Input className="at-input-number__input" style={inputStyle} type={type} value={inputValue} disabled={disabledInput || disabled} onInput={this.handleInput} onBlur={this.handleBlur} />
