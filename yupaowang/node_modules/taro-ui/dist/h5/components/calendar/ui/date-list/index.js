...
export default class AtCalendarList extends Taro.Component {
  ...
  render() {
    ...
    return <View className="at-calendar__list flex">
        {list.map(item => <View key={item.text} onClick={this.handleClick.bind(this, item)} onLongPress={this.handleLongClick.bind(this, item)} className={classnames('flex__item', `flex__item--${MAP[item.type]}`, {
